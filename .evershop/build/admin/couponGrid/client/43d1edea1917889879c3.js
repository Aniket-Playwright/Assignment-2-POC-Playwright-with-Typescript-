...
;// ./node_modules/@evershop/evershop/dist/modules/promotion/pages/admin/couponGrid/rows/CouponName.js

function CouponName({ url, name }) {
    return (react.createElement("td", null,
        react.createElement("div", null,
            react.createElement("a", { className: "hover:underline font-semibold", href: url }, name))));
}
//# sourceMappingURL=CouponName.js.map
;// ./node_modules/@evershop/evershop/dist/modules/promotion/pages/admin/couponGrid/Grid.js
...
function Actions({ coupons = [], selectedIds = [] }) {
    ...
    const updateCoupons = async (status) => {
        ...
        const promises = coupons
            ...
            .map((coupon) => axios/* default */.A.patch(coupon.updateApi, {
            status,
    ...
    const deleteCoupons = async () => {
        ...
        const promises = coupons
            .filter((coupon) => selectedIds.includes(coupon.uuid))
            .map((coupon) => axios/* default */.A.delete(coupon.deleteApi));
        await Promise.all(promises);
        setIsLoading(false);
        // Refresh the page
        window.location.reload();
...
function CouponGrid({ coupons: { items: coupons, total, currentFilters = [] } }) {
    ...
    return (react.createElement(Card, null,
        react.createElement(Card.Session, { title: react.createElement(Form, { submitBtn: false, id: "couponGridFilter" },
                react.createElement("div", { className: "flex gap-5 justify-center items-center" },
                    react.createElement(common_Area, { id: "couponGridFilter", noOuter: true, coreComponents: [
                            {
                                component: {
                                    default: () => {
                                        var _a;
        ...
        react.createElement("table", { className: "listing sticky" },
            react.createElement("thead", null,
                react.createElement("tr", null,
                    ...
                    react.createElement(common_Area, { id: "couponGridHeader", noOuter: true, coreComponents: [
                            {
                                component: {
            ...
            react.createElement("tbody", null,
                ...
                coupons.map((c) => (react.createElement("tr", { key: c.couponId },
                    ...
                    react.createElement(common_Area, { id: "couponGridRow", row: c, noOuter: true, selectedRows: selectedRows, setSelectedRows: setSelectedRows, coreComponents: [
                            {
                                component: {
...
;// ./node_modules/@evershop/evershop/dist/modules/promotion/pages/admin/couponGrid/Heading.js


function CouponGridHeading() {
    return react.createElement(PageHeading, { heading: "Coupons" });
}
...
;// ./node_modules/@evershop/evershop/dist/modules/promotion/pages/admin/couponGrid/NewCouponButton.js


function NewCouponButton({ newCouponUrl }) {
    return react.createElement(common_Button, { url: newCouponUrl, title: "New Coupon" });
}
const NewCouponButton_layout = {
    areaId: 'pageHeadingRight',
    sortOrder: 10
};
const NewCouponButton_query = (/* unused pure expression or super */ null && (`
  query Query {
...
;// ./.evershop/build/admin/couponGrid/client/entry.js
...
common_Area.defaultProps.components = {
  ...
  content: {
    ee3c4834efdbd46c2eed0075e4a5d040d: {
      id: 'ee3c4834efdbd46c2eed0075e4a5d040d',
      sortOrder: 20,
      component: { default: CouponGrid }
    },
    e09ccbd05c1bd7590f1bf204d1d9f42a8: {
      id: 'e09ccbd05c1bd7590f1bf204d1d9f42a8',
      sortOrder: 10,
      component: { default: CouponGridHeading }
    }
  },
  pageHeadingRight: {
    e6cd9b6b50f0889f1e9b7b8ab30777d80: {
      id: 'e6cd9b6b50f0889f1e9b7b8ab30777d80',
      sortOrder: 10,
      component: { default: NewCouponButton }
    }
  },
  '*': {
    collection_products: {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(71742)))
