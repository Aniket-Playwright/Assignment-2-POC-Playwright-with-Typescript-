...
;// ./node_modules/@evershop/evershop/dist/modules/customer/pages/admin/customerGrid/rows/CustomerName.js

function CustomerName({ url, name }) {
    return (react.createElement("td", null,
        react.createElement("div", null,
            react.createElement("a", { className: "hover:underline font-semibold", href: url }, name))));
}
//# sourceMappingURL=CustomerName.js.map
;// ./node_modules/@evershop/evershop/dist/modules/customer/pages/admin/customerGrid/Grid.js
...
function Actions({ customers = [], selectedIds = [] }) {
    ...
    const updateCustomers = async (status) => {
        const promises = customers
            ...
            .map((customer) => axios/* default */.A.patch(customer.updateApi, {
            status
        }));
...
function CustomerGrid({ customers: { items: customers, total, currentFilters = [] } }) {
    ...
    return (react.createElement(Card, null,
        react.createElement(Card.Session, { title: react.createElement(Form, { submitBtn: false, id: "customerGridFilter" },
                react.createElement("div", { className: "flex gap-5 justify-center items-center" },
                    react.createElement(common_Area, { id: "customerGridFilter", noOuter: true, coreComponents: [
                            {
                                component: {
                                    default: () => {
                                        var _a;
        ...
        react.createElement("table", { className: "listing sticky" },
            react.createElement("thead", null,
                react.createElement("tr", null,
                    ...
                    react.createElement(common_Area, { id: "customerGridHeader", noOuter: true, coreComponents: [
                            {
                                component: {
            ...
            react.createElement("tbody", null,
                ...
                customers.map((c) => (react.createElement("tr", { key: c.customerId },
                    ...
                    react.createElement(common_Area, { id: "customerGridRow", row: c, noOuter: true, selectedRows: selectedRows, setSelectedRows: setSelectedRows, coreComponents: [
                            {
                                component: {
                                    default: () => (react.createElement(CustomerName, { name: c.fullName, url: c.editUrl }))
                                },
                                sortOrder: 10
                            },
                            {
                                component: {
                                    default: ({ areaProps }) => react.createElement("td", null, c.email)
                                },
                                sortOrder: 15
                            },
                            {
                            ...
                            {
                                component: {
                                    default: () => react.createElement("td", null, c.createdAt.text)
                                },
                                sortOrder: 25
                            }
                        ] })))))),
...
;// ./node_modules/@evershop/evershop/dist/modules/customer/pages/admin/customerGrid/Heading.js


function CustomerGridHeading() {
    return react.createElement(PageHeading, { heading: "Customers" });
}
...
;// ./.evershop/build/admin/customerGrid/client/entry.js
...
common_Area.defaultProps.components = {
  ...
  content: {
    e2fea7623f9e11750ed6b3b3baca9fb81: {
      id: 'e2fea7623f9e11750ed6b3b3baca9fb81',
      sortOrder: 20,
      component: { default: CustomerGrid }
    },
    e0b75212611880926280c542ba9b943a3: {
      id: 'e0b75212611880926280c542ba9b943a3',
      sortOrder: 10,
      component: { default: CustomerGridHeading }
    }
  },
  '*': {
    collection_products: {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(33312)))
