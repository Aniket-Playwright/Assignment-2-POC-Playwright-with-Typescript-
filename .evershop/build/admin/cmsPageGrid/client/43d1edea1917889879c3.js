...
;// ./node_modules/@evershop/evershop/dist/modules/cms/pages/admin/cmsPageGrid/rows/PageName.js

function PageName({ url, name }) {
    return (react.createElement("td", null,
        react.createElement("div", null,
            react.createElement("a", { className: "hover:underline font-semibold", href: url }, name))));
}
//# sourceMappingURL=PageName.js.map
;// ./node_modules/@evershop/evershop/dist/modules/cms/pages/admin/cmsPageGrid/Grid.js
...
function Actions({ pages = [], selectedIds = [] }) {
    ...
    const updatePages = async (status) => {
        ...
        const promises = pages
            ...
            .map((page) => axios/* default */.A.patch(page.updateApi, {
            status
        }));
    ...
    const deletePages = async () => {
        ...
        const promises = pages
            .filter((page) => selectedIds.includes(page.uuid))
            .map((page) => axios/* default */.A.delete(page.deleteApi));
        await Promise.all(promises);
        setIsLoading(false);
        // Refresh the page
        window.location.reload();
...
function CMSPageGrid({ cmsPages: { items: pages, total, currentFilters = [] } }) {
    ...
    return (react.createElement(Card, null,
        react.createElement(Card.Session, { title: react.createElement(Form, { submitBtn: false, id: "pageGridFilter" },
                react.createElement(common_Area, { id: "cmsPageGridFilter", noOuter: true, coreComponents: [
                        {
                            component: {
                                default: () => {
                                    var _a;
        ...
        react.createElement("table", { className: "listing sticky" },
            react.createElement("thead", null,
                react.createElement("tr", null,
                    ...
                    react.createElement(common_Area, { className: "", id: "pageGridHeader", noOuter: true, coreComponents: [
                            {
                                component: {
            ...
            react.createElement("tbody", null,
                ...
                pages.map((p, i) => (react.createElement("tr", { key: i },
                    ...
                    react.createElement(common_Area, { className: "", id: "pageGridRow", row: p, noOuter: true, coreComponents: [
                            {
                                component: {
...
;// ./node_modules/@evershop/evershop/dist/modules/cms/pages/admin/cmsPageGrid/NewPageButton.js



function NewPageButton({ newPageUrl }) {
    return react.createElement(common_Button, { url: newPageUrl, title: "New Page" });
}
NewPageButton.propTypes = {
    newPageUrl: (prop_types_default()).string.isRequired
};
const NewPageButton_layout = {
    areaId: 'pageHeadingRight',
    sortOrder: 10
};
const NewPageButton_query = (/* unused pure expression or super */ null && (`
  query Query {
...
;// ./node_modules/@evershop/evershop/dist/modules/cms/pages/admin/cmsPageGrid/PageHeading.js


function CmsPageHeading() {
    return react.createElement(PageHeading, { heading: "Cms Pages" });
}
...
;// ./.evershop/build/admin/cmsPageGrid/client/entry.js
...
common_Area.defaultProps.components = {
  ...
  content: {
    e20b4ff51924c110c1f926d9116600ab7: {
      id: 'e20b4ff51924c110c1f926d9116600ab7',
      sortOrder: 20,
      component: { default: CMSPageGrid }
    },
    ee785af9e2fd9e8fda535171c19372bc4: {
      id: 'ee785af9e2fd9e8fda535171c19372bc4',
      sortOrder: 10,
      component: { default: CmsPageHeading }
    }
  },
  pageHeadingRight: {
    e3ad64ba472dc43c54f1dc665421cfd4f: {
      id: 'e3ad64ba472dc43c54f1dc665421cfd4f',
      sortOrder: 10,
      component: { default: NewPageButton }
    }
  },
  '*': {
    collection_products: {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(49681)))
