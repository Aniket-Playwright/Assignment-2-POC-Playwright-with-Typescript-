...
;// ./node_modules/@evershop/evershop/dist/modules/oms/pages/admin/orderGrid/rows/OrderNumber.js

function OrderNumber({ editUrl, number }) {
...
;// ./node_modules/@evershop/evershop/dist/modules/oms/pages/admin/orderGrid/rows/PaymentStatus.js
...
;// ./node_modules/@evershop/evershop/dist/modules/oms/pages/admin/orderGrid/rows/ShipmentStatus.js
...
;// ./node_modules/@evershop/evershop/dist/modules/oms/pages/admin/orderGrid/Grid.js
...
function Actions({ orders = [], selectedIds = [] }) {
    ...
    const fullFillOrders = async () => {
        ...
        const promises = orders
            ...
            .map((order) => axios/* default */.A.post(order.createShipmentApi));
...
function OrderGrid({ orders: { items: orders, total, currentFilters = [] }, paymentStatusList, shipmentStatusList }) {
    ...
    return (react.createElement(Card, null,
        react.createElement(Card.Session, { title: react.createElement(Form, { submitBtn: false, id: "orderGridFilter" },
                react.createElement("div", { className: "flex gap-5 justify-center items-center" },
                    react.createElement(common_Area, { id: "orderGridFilter", noOuter: true, coreComponents: [
                            {
                                component: {
                                    default: () => {
                                        var _a;
        ...
        react.createElement("table", { className: "listing sticky" },
            react.createElement("thead", null,
                react.createElement("tr", null,
                    ...
                    react.createElement(common_Area, { className: "", id: "orderGridHeader", noOuter: true, coreComponents: [
                            {
                                component: {
            ...
            react.createElement("tbody", null,
                ...
                orders.map((o) => (react.createElement("tr", { key: o.orderId },
                    ...
                    react.createElement(common_Area, { className: "", id: "orderGridRow", row: o, noOuter: true, coreComponents: [
                            {
                                component: {
    ...
    orders: prop_types_default().shape({
        items: prop_types_default().arrayOf(prop_types_default().shape({
            ...
            shipmentStatus: prop_types_default().shape({
                ...
                progress: (prop_types_default()).string.isRequired
            }).isRequired,
...
;// ./node_modules/@evershop/evershop/dist/modules/oms/pages/admin/orderGrid/Heading.js


function OrderGridHeading() {
    return react.createElement(PageHeading, { heading: "Orders" });
}
...
;// ./.evershop/build/admin/orderGrid/client/entry.js
...
common_Area.defaultProps.components = {
  ...
  content: {
    ea93c925d49b6d5ecb8fbe2abe81130da: {
      id: 'ea93c925d49b6d5ecb8fbe2abe81130da',
      sortOrder: 20,
      component: { default: OrderGrid }
    },
    eba68934da64d5e96276993030a34aed0: {
      id: 'eba68934da64d5e96276993030a34aed0',
      sortOrder: 10,
      component: { default: OrderGridHeading }
    }
  },
  '*': {
    collection_products: {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(15808)))
