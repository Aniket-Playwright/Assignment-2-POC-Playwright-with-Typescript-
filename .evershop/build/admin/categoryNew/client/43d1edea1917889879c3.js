...
;// ./node_modules/@evershop/evershop/dist/modules/catalog/pages/admin/categoryNew/CategoryNewForm.js





function CategoryNewForm({ action, gridUrl }) {
    return (react.createElement(Form, { action: action, method: "POST", id: "categoryNewForm", onSuccess: (response) => {
            react_toastify_esm/* toast */.oR.success('Category created successfully!');
            setTimeout(() => {
        ...
        react.createElement(FormButtons, { formId: "categoryNewForm", cancelUrl: gridUrl })));
}
const CategoryNewForm_layout = {
    areaId: 'content',
    sortOrder: 10
};
const CategoryNewForm_query = (/* unused pure expression or super */ null && (`
  query Query {
...
;// ./.evershop/build/admin/categoryNew/client/entry.js
...
common_Area.defaultProps.components = {
  ...
  content: {
    ...
    eb85e35a6eba8f4075005820d647a61bc: {
      id: 'eb85e35a6eba8f4075005820d647a61bc',
      sortOrder: 10,
      component: { default: CategoryNewForm }
    }
  },
  settingPageMenu: {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(1496)))
