...
;// ./node_modules/@evershop/evershop/dist/modules/catalog/pages/admin/collectionGrid/rows/CollectionNameRow.js

function CollectionNameRow({ name, url }) {
...
;// ./node_modules/@evershop/evershop/dist/modules/catalog/pages/admin/collectionGrid/Grid.js
...
function Actions({ collections = [], selectedIds = [] }) {
    ...
    const deleteCategories = async () => {
        ...
        const promises = collections
            ...
            .map((col) => axios/* default */.A.delete(col.deleteApi));
...
function CollectionGrid({ collections: { items: collections, total, currentFilters = [] } }) {
    var _a;
            ...
            react.createElement("table", { className: "listing sticky" },
                react.createElement("thead", null,
                    react.createElement("tr", null,
                        ...
                        react.createElement(common_Area, { className: "", id: "collectionGridHeader", noOuter: true, coreComponents: [
                                {
                                    component: {
                ...
                react.createElement("tbody", null,
                    ...
                    collections.map((c) => (react.createElement("tr", { key: c.collectionId },
                        ...
                        react.createElement(common_Area, { className: "", id: "collectionGridRow", row: c, noOuter: true, coreComponents: [
                                {
                                    component: {
                                        default: () => react.createElement("td", null, c.collectionId.toString())
                                    },
                                    sortOrder: 5
                                },
                                {
                                ...
                                {
                                    component: {
                                        default: () => react.createElement("td", null, c.code)
                                    },
                                    sortOrder: 15
                                }
                            ] })))))),
...
;// ./node_modules/@evershop/evershop/dist/modules/catalog/pages/admin/collectionGrid/NewCollectionButton.js



function NewCollectionButton({ newCollectionUrl }) {
    return react.createElement(common_Button, { url: newCollectionUrl, title: "New Collection" });
}
NewCollectionButton.propTypes = {
    newCollectionUrl: (prop_types_default()).string.isRequired
};
const NewCollectionButton_layout = {
    areaId: 'pageHeadingRight',
    sortOrder: 10
};
const NewCollectionButton_query = (/* unused pure expression or super */ null && (`
  query Query {
...
;// ./node_modules/@evershop/evershop/dist/modules/catalog/pages/admin/collectionGrid/PageHeading.js


function CollectionGridPageHeading() {
    return (react.createElement("div", { className: "w-2/3", style: { margin: '0 auto' } },
        react.createElement(PageHeading, { heading: "Collections" })));
}
...
;// ./.evershop/build/admin/collectionGrid/client/entry.js
...
common_Area.defaultProps.components = {
  ...
  content: {
    ef4237523bd46557ac12f295ecb41f4c0: {
      id: 'ef4237523bd46557ac12f295ecb41f4c0',
      sortOrder: 20,
      component: { default: CollectionGrid }
    },
    e55b8f44b32ba621524b80a95cf29cc17: {
      id: 'e55b8f44b32ba621524b80a95cf29cc17',
      sortOrder: 10,
      component: { default: CollectionGridPageHeading }
    }
  },
  pageHeadingRight: {
    e4b7ebe691449dad19712841649b6c5c4: {
      id: 'e4b7ebe691449dad19712841649b6c5c4',
      sortOrder: 10,
      component: { default: NewCollectionButton }
    }
  },
  settingPageMenu: {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(38882)))
