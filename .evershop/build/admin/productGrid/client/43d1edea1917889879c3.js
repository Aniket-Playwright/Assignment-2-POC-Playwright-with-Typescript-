...
;// ./node_modules/@evershop/evershop/dist/components/admin/grid/Filter.js


function Filter({ title, options, selectedOption }) {
...
;// ./node_modules/@evershop/evershop/dist/components/admin/grid/header/Dummy.js

function DummyColumnHeader({ title }) {
...
function Image_Image({ src, width, height, alt, quality = 75, loading = 'eager', decoding = 'async', priority = false, sizes = '100vw', objectFit = 'unset', ...props }) {
...
;// ./node_modules/@evershop/evershop/dist/components/admin/grid/Thumbnail.js


function Thumbnail({ src, name }) {
    return (react.createElement("td", null,
        react.createElement("div", { className: "grid-thumbnail text-border border border-divider p-2 rounded flex justify-center", style: { width: '4rem', height: '4rem' } },
            src && (react.createElement(Image_Image, { className: "self-center", src: src, alt: name || '', width: 100, height: 100 })),
...
;// ./node_modules/@evershop/evershop/dist/modules/catalog/pages/admin/productGrid/rows/ProductName.js

function ProductNameRow({ url, name }) {
    return (react.createElement("td", null,
        react.createElement("div", null,
            react.createElement("a", { className: "hover:underline font-semibold", href: url }, name))));
}
//# sourceMappingURL=ProductName.js.map
;// ./node_modules/@evershop/evershop/dist/modules/catalog/pages/admin/productGrid/Grid.js
...
function Actions({ products = [], selectedIds = [] }) {
    ...
    const updateProducts = async (status) => {
        ...
        const promises = products
            ...
            .map((product) => axios/* default */.A.patch(product.updateApi, {
            status
        }));
    ...
    const deleteProducts = async () => {
        ...
        const promises = products
            .filter((product) => selectedIds.includes(product.uuid))
            .map((product) => axios/* default */.A.delete(product.deleteApi));
        await Promise.all(promises);
        setIsLoading(false);
        // Refresh the page
        window.location.reload();
...
function ProductGrid({ products: { items: products, total, currentFilters = [] } }) {
    ...
    return (react.createElement(Card, null,
        react.createElement(Card.Session, { title: react.createElement(Form, { submitBtn: false, id: "productGridFilter" },
                react.createElement("div", { className: "flex gap-5 justify-center items-center" },
                    react.createElement(common_Area, { id: "productGridFilter", noOuter: true, coreComponents: [
                            {
                                component: {
                                    default: () => {
                                        var _a;
        ...
        react.createElement("table", { className: "listing sticky" },
            react.createElement("thead", null,
                react.createElement("tr", null,
                    ...
                    react.createElement(common_Area, { id: "productGridHeader", noOuter: true, coreComponents: [
                            {
                                component: {
            ...
            react.createElement("tbody", null,
                ...
                products.map((p) => (react.createElement("tr", { key: p.uuid },
                    ...
                    react.createElement(common_Area, { id: "productGridRow", row: p, noOuter: true, selectedRows: selectedRows, setSelectedRows: setSelectedRows, coreComponents: [
                            {
                                component: {
                                    default: () => {
                                        var _a;
...
;// ./node_modules/@evershop/evershop/dist/modules/catalog/pages/admin/productGrid/NewProductButton.js



function NewProductButton({ newProductUrl }) {
    return react.createElement(common_Button, { url: newProductUrl, title: "New Product" });
}
NewProductButton.propTypes = {
    newProductUrl: (prop_types_default()).string.isRequired
};
const NewProductButton_layout = {
    areaId: 'pageHeadingRight',
    sortOrder: 10
};
const NewProductButton_query = (/* unused pure expression or super */ null && (`
  query Query {
    newProductUrl: url(routeId: "productNew")
  }
`));
...
;// ./node_modules/@evershop/evershop/dist/modules/catalog/pages/admin/productGrid/PageHeading.js
...
;// ./.evershop/build/admin/productGrid/client/entry.js
...
common_Area.defaultProps.components = {
  ...
  content: {
    efcbcff742c8af90b02e95ad2b0bbd8c9: {
      id: 'efcbcff742c8af90b02e95ad2b0bbd8c9',
      sortOrder: 20,
      component: { default: ProductGrid }
    },
    e8c776a571ae325822805e03524d0cd1f: {
      id: 'e8c776a571ae325822805e03524d0cd1f',
      sortOrder: 10,
      component: { default: ProductEditPageHeading }
    }
  },
  pageHeadingRight: {
    ee42d31ef1b3421cd8f4c40a74b2340d0: {
      id: 'ee42d31ef1b3421cd8f4c40a74b2340d0',
      sortOrder: 10,
      component: { default: NewProductButton }
    }
  },
  settingPageMenu: {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(8793)))
