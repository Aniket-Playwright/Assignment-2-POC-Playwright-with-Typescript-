...
;// ./node_modules/@evershop/evershop/dist/modules/cms/pages/admin/dashboard/Layout.js
...
;// ./node_modules/@evershop/evershop/dist/modules/cms/pages/admin/dashboard/PageHeading.js


function DashboardPageHeading() {
    return react.createElement(PageHeading, { heading: "Dashboard" });
}
...
;// ./node_modules/@evershop/evershop/dist/modules/oms/pages/admin/dashboard/Bestsellers.js





function BestSellers({ bestSellers, listUrl }) {
                        ...
                        return (react.createElement("tr", { key: i },
                            react.createElement("td", null,
                                react.createElement("div", { className: " flex justify-left" },
                                    react.createElement("div", { className: "flex justify-start gap-2 items-center" },
                                        react.createElement("div", { className: "grid-thumbnail text-border border border-divider p-2 rounded" },
                                            ((_a = p.image) === null || _a === void 0 ? void 0 : _a.url) && (react.createElement(Image_Image, { src: p.image.url, alt: p.name, width: 50, height: 50 })),
                                            !((_b = p.image) === null || _b === void 0 ? void 0 : _b.url) && (react.createElement(ProductNoThumbnail, { width: 50, height: 50 }))),
                                        react.createElement("div", null,
...
const Bestsellers_layout = {
    areaId: 'leftSide',
    sortOrder: 20
};
const Bestsellers_query = (/* unused pure expression or super */ null && (`
  query Query {
    bestSellers {
      name
      price {
...
var ResponsiveContainer = __webpack_require__(44653);
// EXTERNAL MODULE: ./node_modules/recharts/es6/chart/PieChart.js + 3 modules
var PieChart = __webpack_require__(30630);
...
;// ./node_modules/@evershop/evershop/dist/modules/oms/pages/admin/dashboard/Lifetimesales.js
        ...
        return (react.createElement(Card, { title: "Lifetime Sales" },
            ...
            react.createElement(Card.Session, null,
                react.createElement("div", { style: { height: '200px' } },
                    react.createElement(ResponsiveContainer/* ResponsiveContainer */.u, { width: "100%", height: "100%" },
                        react.createElement(PieChart/* PieChart */.r, null,
                            react.createElement(Pie/* Pie */.F, { data: chartData, labelLine: false, fill: "#8884d8", dataKey: "value", label: true }, chartData.map((entry, index) => (react.createElement(Cell/* Cell */.f, { key: `cell-${index}`, fill: COLORS[index % COLORS.length] }))))))))));
    }
}
LifetimeSale.propTypes = {
    api: (prop_types_default()).string.isRequired
};
const Lifetimesales_layout = {
    areaId: 'rightSide',
    sortOrder: 10
};
const Lifetimesales_query = (/* unused pure expression or super */ null && (`
  query Query {
...
// EXTERNAL MODULE: ./node_modules/recharts/es6/component/Tooltip.js + 2 modules
var Tooltip = __webpack_require__(35683);
// EXTERNAL MODULE: ./node_modules/recharts/es6/cartesian/Area.js
var cartesian_Area = __webpack_require__(84124);
;// ./node_modules/@evershop/evershop/dist/modules/oms/pages/admin/dashboard/Statistic.js
...
function SaleStatistic({ api }) {
    const [data, setData] = (0,react.useState)([]);
    const [period, setPeriod] = (0,react.useState)('monthly');
    ...
    if (fetching) {
        ...
        return (react.createElement(Card, { title: "Sale Statistics", actions: [
            ...
            react.createElement(Card.Session, null, data.length === 0 ? null : (react.createElement(ResponsiveContainer/* ResponsiveContainer */.u, { width: "100%", height: 300 },
                react.createElement(AreaChart/* AreaChart */.Q, { data: data, margin: {
                        top: 5,
                        right: 0,
                        left: -25,
                        bottom: 5
                    } },
                    react.createElement(XAxis/* XAxis */.W, { dataKey: "time" }),
                    react.createElement(YAxis/* YAxis */.h, null),
                    react.createElement(Tooltip/* Tooltip */.m, null),
                    react.createElement(cartesian_Area/* Area */.G, { type: "monotone", dataKey: "value", stackId: "1", stroke: "#8884d8", fill: "#8884d8" }),
                    react.createElement(cartesian_Area/* Area */.G, { type: "monotone", dataKey: "count", stackId: "1", stroke: "#82ca9d", fill: "#82ca9d" })))))));
    }
}
SaleStatistic.propTypes = {
    api: (prop_types_default()).string.isRequired
};
const Statistic_layout = {
    areaId: 'leftSide',
    sortOrder: 10
};
const Statistic_query = (/* unused pure expression or super */ null && (`
  query Query {
...
function Tooltip_Tooltip({ content, position = 'top', className = '' }) {
...
function NumberField({ name, label, placeholder, className = '', wrapperClassName, required = false, disabled = false, min, max, step, allowDecimals = true, unit, unitPosition = 'right', defaultValue, error, helperText, validation, onChange, prefixIcon, suffixIcon, ...props }) {
    ...
    return (react.createElement("div", { className: `form-field ${wrapperClassName || ''}`.trim() },
        label && (react.createElement("label", { htmlFor: fieldId },
            ...
            helperText && react.createElement(Tooltip_Tooltip, { content: helperText, position: "top" }))),
...
;// ./.evershop/build/admin/dashboard/client/entry.js
...
common_Area.defaultProps.components = {
  ...
  content: {
    e92ed67e60eba7bcc40b84e6e35958f33: {
      ...
      sortOrder: 10,
      component: { default: DashboardLayout }
    },
    e9364c1dcff32c3fca155f9b63ee74f19: {
      id: 'e9364c1dcff32c3fca155f9b63ee74f19',
      sortOrder: 5,
      component: { default: DashboardPageHeading }
    }
  },
  leftSide: {
  ...
  rightSide: {
    e48a771efbbc844c2c177553e8367ddfc: {
      ...
      sortOrder: 10,
      component: { default: LifetimeSale }
    }
  },
  '*': {
    collection_products: {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(5832)))
