...
;// ./node_modules/@evershop/evershop/dist/modules/cms/pages/admin/widgetEdit/WidgetEditForm.js





function WidgetEditForm({ action, gridUrl, type }) {
    return (react.createElement(Form, { action: action, method: "PATCH", id: "widgetEditForm", submitBtn: false },
        react.createElement(InputField, { type: "hidden", name: "type", defaultValue: type.code }),
        ...
        react.createElement(FormButtons, { formId: "widgetEditForm", cancelUrl: gridUrl })));
}
const WidgetEditForm_layout = {
    areaId: 'content',
    sortOrder: 10
};
const WidgetEditForm_query = (/* unused pure expression or super */ null && (`
  query Query {
...
`));
//# sourceMappingURL=WidgetEditForm.js.map
...
const AreaInput = ({ values, control }) => {
    ...
    return (react.createElement(index_esm/* Controller */.xI, { name: "area", control: control, defaultValue: values.map((v) => v.value), render: ({ field }) => (react.createElement(react_select_creatable_esm/* default */.A, { components: components, inputValue: inputValue, isClearable: true, isMulti: true, menuIsOpen: false, onChange: (newValue) => {
...
function General({ widget, routes }) {
    var _a;
    const { register, control } = (0,index_esm/* useFormContext */.xW)();
    const allRoutes = [
        {
            value: 'all',
            label: 'All',
    ...
    return (react.createElement(Card, null,
        ...
        react.createElement(Card.Session, { title: "Page" },
            react.createElement(index_esm/* Controller */.xI, { name: "route", control: control, defaultValue: (widget === null || widget === void 0 ? void 0 : widget.route)
                    ? widget.route // Keep as string array
                    : [], render: ({ field }) => (react.createElement(react_select_esm/* default */.Ay, { options: allRoutes.filter((r) => r.isApi === false &&
                        r.isAdmin === false &&
...
common_Area.defaultProps.components = {
  ...
  content: {
    e903fcbf9f2c20b5b318760a7ce9aa45b: {
      id: 'e903fcbf9f2c20b5b318760a7ce9aa45b',
      sortOrder: 10,
      component: { default: WidgetEditForm }
    },
    e933e309d1cdbe66a05b405ffcfbdb12f: {
      id: 'e933e309d1cdbe66a05b405ffcfbdb12f',
      sortOrder: 5,
      component: { default: WidgetEditPageHeading }
    }
  },
  rightSide: {
    e922a3d310011e379b25b11e483a51be8: {
      id: 'e922a3d310011e379b25b11e483a51be8',
      sortOrder: 15,
      component: { default: General }
    }
  },
  leftSide: {
    e5ba368fbe7cb4812478b46ebf8c5ffc7: {
      id: 'e5ba368fbe7cb4812478b46ebf8c5ffc7',
      sortOrder: 30,
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(98347)))
