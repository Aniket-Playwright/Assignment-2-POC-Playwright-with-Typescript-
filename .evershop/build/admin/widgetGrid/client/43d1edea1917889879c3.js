...
;// ./node_modules/@evershop/evershop/dist/components/admin/grid/header/Sortable.js
...
function SortableHeader({ title, name, currentFilters }) {
...
// EXTERNAL MODULE: ./node_modules/@heroicons/react/24/outline/esm/ChevronDoubleLeftIcon.js
var ChevronDoubleLeftIcon = __webpack_require__(53638);
// EXTERNAL MODULE: ./node_modules/@heroicons/react/24/outline/esm/ChevronDoubleRightIcon.js
var ChevronDoubleRightIcon = __webpack_require__(38331);
;// ./node_modules/@evershop/evershop/dist/components/admin/grid/Pagination.js
                ...
                page > 1 && (react.createElement(react.Fragment, null,
                    react.createElement("div", { className: "first self-center" },
                        react.createElement("a", { href: "#", onClick: (e) => onFirst(e) },
                            react.createElement(ChevronDoubleLeftIcon/* default */.A, { width: 20, height: 20 }))),
                ...
                page * limit < total && (react.createElement(react.Fragment, null,
                    ...
                    react.createElement("div", { className: "last self-center" },
                        react.createElement("a", { href: "#", onClick: (e) => onLast(e) },
                            react.createElement(ChevronDoubleRightIcon/* default */.A, { width: 20, height: 20 }))))),
                react.createElement("div", { className: "self-center" },
                    react.createElement("span", null,
                        total,
                        " records"))))));
...
;// ./node_modules/@evershop/evershop/dist/components/admin/Status.js


function Status({ status }) {
    return (react.createElement("td", null,
        react.createElement("div", null,
            status === 0 && react.createElement(Dot, { variant: "default", size: "1rem" }),
            status === 1 && react.createElement(Dot, { variant: "success", size: "1rem" }))));
}
...
;// ./node_modules/@evershop/evershop/dist/modules/cms/pages/admin/widgetGrid/rows/Name.js
...
;// ./node_modules/@evershop/evershop/dist/modules/cms/pages/admin/widgetGrid/rows/WidgetTypeRow.js

function WidgetTypeRow({ code, types }) {
...
;// ./node_modules/@evershop/evershop/dist/modules/cms/pages/admin/widgetGrid/Grid.js
...
function Actions({ widgets = [], selectedIds = [] }) {
    ...
    const updatePages = async (status) => {
        ...
        const promises = widgets
            ...
            .map((widget) => axios/* default */.A.patch(widget.updateApi, {
            status
        }));
    ...
    const deletePages = async () => {
        ...
        const promises = widgets
            .filter((widget) => selectedIds.includes(widget.uuid))
            .map((widget) => axios/* default */.A.delete(widget.deleteApi));
        await Promise.all(promises);
        setIsLoading(false);
        // Refresh the page
        window.location.reload();
...
Actions.propTypes = {
    ...
    widgets: prop_types_default().arrayOf(prop_types_default().shape({
...
function WidgetGrid({ widgets: { items, total, currentFilters = [] }, widgetTypes }) {
    ...
    return (react.createElement(Card, null,
        react.createElement(Card.Session, { title: react.createElement(Form, { submitBtn: false, id: "widgetGridFilter" },
                react.createElement(common_Area, { id: "widgetGridFilter", noOuter: true, coreComponents: [
                        {
                            component: {
                                default: () => {
                                    var _a;
        ...
        react.createElement("table", { className: "listing sticky" },
            react.createElement("thead", null,
                react.createElement("tr", null,
                    ...
                    react.createElement(common_Area, { className: "", id: "widgetGridHeader", noOuter: true, coreComponents: [
                            {
                                component: {
            ...
            react.createElement("tbody", null,
                ...
                items.map((w, i) => (react.createElement("tr", { key: i },
                    ...
                    react.createElement(common_Area, { className: "", id: "widgetGridRow", row: w, noOuter: true, coreComponents: [
                            {
                                component: {
...
WidgetGrid.propTypes = {
    widgets: prop_types_default().shape({
    ...
    widgetTypes: prop_types_default().arrayOf(prop_types_default().shape({
...
const Grid_query = (/* unused pure expression or super */ null && (`
  query Query($filters: [FilterInput]) {
...
;// ./node_modules/@evershop/evershop/dist/modules/cms/pages/admin/widgetGrid/Heading.js


function WidgetGridHeading() {
...
;// ./node_modules/@evershop/evershop/dist/modules/cms/pages/admin/widgetGrid/NewWidgetButton.js



const WidgetTypes = ({ types }) => {
    return (react.createElement("div", { className: "grid grid-cols-2 gap-4 p-2" }, types.map((type) => (react.createElement("a", { key: type.code, href: type.createWidgetUrl, className: "group relative flex flex-col items-center justify-center p-4 border-2 border-gray-200 rounded-lg hover:border-primary hover:shadow-md transition-all duration-200 ease-in-out bg-white hover:bg-gray-50" },
        react.createElement("div", { className: "text-base font-semibold text-gray-900 group-hover:text-primary transition-colors" }, type.name),
        type.description && (react.createElement("div", { className: "mt-2 text-sm text-gray-500 text-center" }, type.description)))))));
};
function NewWidgetButton({ widgetTypes }) {
    const { openAlert, closeAlert } = useAlertContext();
    return (react.createElement(common_Button, { title: "New Widget", onAction: () => {
            openAlert({
                heading: `Select type`,
...
const NewWidgetButton_layout = {
    areaId: 'pageHeadingRight',
    sortOrder: 10
};
const NewWidgetButton_query = (/* unused pure expression or super */ null && (`
  query Query {
    widgetTypes {
      code
      name
...
;// ./.evershop/build/admin/widgetGrid/client/entry.js
...
common_Area.defaultProps.components = {
  ...
  content: {
    e3f91e7f70bddb2325f9601ef5c37bb71: {
      id: 'e3f91e7f70bddb2325f9601ef5c37bb71',
      sortOrder: 20,
      component: { default: WidgetGrid }
    },
    eb5cd5207b339aaa2689a4e1a9ceabcf1: {
      id: 'eb5cd5207b339aaa2689a4e1a9ceabcf1',
      sortOrder: 10,
      component: { default: WidgetGridHeading }
    }
  },
  pageHeadingRight: {
    ea6a621c08de963d287553186ca8f2b8f: {
      id: 'ea6a621c08de963d287553186ca8f2b8f',
      sortOrder: 10,
      component: { default: NewWidgetButton }
    }
  },
  '*': {
    collection_products: {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(53433)))
