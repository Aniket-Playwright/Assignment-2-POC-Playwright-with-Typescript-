        ...
        react.createElement(Card.Session, null,
            react.createElement("div", { className: "grid grid-cols-3 gap-5" },
                ...
                react.createElement("div", { className: "col-span-2" },
                    react.createElement(ToggleField, { name: "codPaymentStatus", defaultValue: codPaymentStatus, trueValue: 1, falseValue: 0 })))),
        react.createElement(Card.Session, null,
            react.createElement("div", { className: "grid grid-cols-3 gap-5" },
                react.createElement("div", { className: "col-span-1 items-center flex" },
                    react.createElement("h4", null, "Dislay Name")),
                react.createElement("div", { className: "col-span-2" },
                    react.createElement(InputField, { name: "codDisplayName", placeholder: "Display Name", defaultValue: codDisplayName }))))));
}
    ...
    return (react.createElement(Card, { title: "Paypal Payment" },
        react.createElement(Card.Session, null,
            react.createElement("div", { className: "grid grid-cols-3 gap-5" },
                react.createElement("div", { className: "col-span-1 items-center flex" },
                    react.createElement("h4", null, "Enable?")),
                react.createElement("div", { className: "col-span-2" },
                    react.createElement(ToggleField, { name: "paypalPaymentStatus", defaultValue: paypalPaymentStatus, trueValue: 1, falseValue: 0 })))),
        react.createElement(Card.Session, null,
            react.createElement("div", { className: "grid grid-cols-3 gap-5" },
                react.createElement("div", { className: "col-span-1 items-center flex" },
                    react.createElement("h4", null, "Dislay Name")),
                react.createElement("div", { className: "col-span-2" },
                    react.createElement(InputField, { label: "Display Name", name: "paypalDisplayName", placeholder: "Display Name", defaultValue: paypalDisplayName })))),
        react.createElement(Card.Session, null,
            react.createElement("div", { className: "grid grid-cols-3 gap-5" },
                react.createElement("div", { className: "col-span-1 items-center flex" },
                    react.createElement("h4", null, "Client ID")),
                react.createElement("div", { className: "col-span-2" },
                    react.createElement(InputField, { label: "Client ID", name: "paypalClientId", placeholder: "Client ID", defaultValue: paypalClientId })))),
        react.createElement(Card.Session, null,
            react.createElement("div", { className: "grid grid-cols-3 gap-5" },
                react.createElement("div", { className: "col-span-1 items-center flex" },
                    react.createElement("h4", null, "Client Secret")),
                react.createElement("div", { className: "col-span-2" },
                    react.createElement(InputField, { name: "paypalClientSecret", placeholder: "Secret Key", label: "Client Secret", defaultValue: paypalClientSecret })))),
        react.createElement(Card.Session, null,
            react.createElement("div", { className: "grid grid-cols-3 gap-5" },
                react.createElement("div", { className: "col-span-1 items-center flex" },
                    react.createElement("h4", null, "Environment")),
                react.createElement("div", { className: "col-span-2" },
                    react.createElement(RadioGroupField, { label: "Environment", name: "paypalEnvironment", defaultValue: paypalEnvironment, options: [
                            {
                                label: 'Sandbox',
        ...
        react.createElement(Card.Session, null,
            react.createElement("div", { className: "grid grid-cols-3 gap-5" },
                ...
                react.createElement("div", { className: "col-span-2" },
                    react.createElement(RadioGroupField, { name: "paypalPaymentIntent", defaultValue: paypalPaymentIntent, options: [
    ...
    return (react.createElement("div", { className: "main-content-inner" },
        react.createElement("div", { className: "grid grid-cols-6 gap-x-5 grid-flow-row " },
            ...
            react.createElement("div", { className: "col-span-4" },
                react.createElement(Form, { id: "paymentSettingForm", method: "POST", action: saveSettingApi, successMessage: "Payment setting saved" },
                    react.createElement(common_Area, { id: "paymentSetting", className: "grid gap-5" }))))));
}
        ...
        react.createElement(Card.Session, null,
            react.createElement("div", { className: "grid grid-cols-3 gap-5" },
                react.createElement("div", { className: "col-span-1 items-center flex" },
                    react.createElement("h4", null, "Enable?")),
                react.createElement("div", { className: "col-span-2" },
                    react.createElement(ToggleField, { name: "stripePaymentStatus", defaultValue: stripePaymentStatus, trueValue: 1, falseValue: 0 })))),
        react.createElement(Card.Session, null,
            react.createElement("div", { className: "grid grid-cols-3 gap-5" },
                react.createElement("div", { className: "col-span-1 items-center flex" },
                    react.createElement("h4", null, "Dislay Name")),
                react.createElement("div", { className: "col-span-2" },
                    react.createElement(InputField, { label: "Display Name", name: "stripeDisplayName", placeholder: "Display Name", defaultValue: stripeDisplayName })))),
        react.createElement(Card.Session, null,
            react.createElement("div", { className: "grid grid-cols-3 gap-5" },
                react.createElement("div", { className: "col-span-1 items-center flex" },
                    react.createElement("h4", null, "Publishable Key")),
                react.createElement("div", { className: "col-span-2" },
                    react.createElement(InputField, { label: "Publishable Key", name: "stripePublishableKey", placeholder: "Publishable Key", defaultValue: stripePublishableKey })))),
        react.createElement(Card.Session, null,
            react.createElement("div", { className: "grid grid-cols-3 gap-5" },
                react.createElement("div", { className: "col-span-1 items-center flex" },
                    react.createElement("h4", null, "Secret Key")),
                react.createElement("div", { className: "col-span-2" },
                    react.createElement(InputField, { label: "Secret Key", name: "stripeSecretKey", placeholder: "Secret Key", defaultValue: stripeSecretKey })))),
        react.createElement(Card.Session, null,
            react.createElement("div", { className: "grid grid-cols-3 gap-5" },
                react.createElement("div", { className: "col-span-1 items-center flex" },
                    react.createElement("h4", null, "Webhook Secret Key")),
                react.createElement("div", { className: "col-span-2" },
                    react.createElement(InputField, { name: "stripeEndpointSecret", placeholder: "Secret Key", label: "Webhook Secret Key", defaultValue: stripeEndpointSecret, helperText: "Your webhook url should be: https://yourdomain.com/api/stripe/webhook" })))),
        react.createElement(Card.Session, null,
            react.createElement("div", { className: "grid grid-cols-3 gap-5" },
                react.createElement("div", { className: "col-span-1 items-center flex" },
                    react.createElement("h4", null, "Payment mode")),
                react.createElement("div", { className: "col-span-2" },
                    react.createElement(RadioGroupField, { name: "stripePaymentMode", defaultValue: stripePaymentMode, options: [
...
common_Area.defaultProps.components = {
  ...
  paymentSetting: {
    e41cdd2f648e169b77f0a92bdb4acfc59: {
      id: 'e41cdd2f648e169b77f0a92bdb4acfc59',
      sortOrder: 20,
      component: { default: CODPayment }
    },
    eeafadd25270cddc8fc8f9f64b3320b8f: {
      id: 'eeafadd25270cddc8fc8f9f64b3320b8f',
      sortOrder: 15,
      component: { default: PaypalPayment }
    },
    ed3fbe3643855f7aa632d10f652ccabc7: {
      id: 'ed3fbe3643855f7aa632d10f652ccabc7',
      sortOrder: 10,
      component: { default: StripePayment }
    }
  },
  content: {
    ef597b5c30927857315f505f2bc573d40: {
      id: 'ef597b5c30927857315f505f2bc573d40',
      sortOrder: 10,
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(9013)))
