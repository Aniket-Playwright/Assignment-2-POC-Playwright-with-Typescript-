...
function WidgetNewForm({ action, gridUrl, type }) {
    return (react.createElement(Form, { action: action, method: "POST", onSuccess: (response) => {
        ...
        react.createElement(FormButtons, { formId: "widgetNewForm", cancelUrl: gridUrl })));
}
...
common_Area.defaultProps.components = {
  ...
  content: {
    ...
    e215833db4bc169880251eaf255b9e8ba: {
      id: 'e215833db4bc169880251eaf255b9e8ba',
      sortOrder: 10,
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(60600)))
