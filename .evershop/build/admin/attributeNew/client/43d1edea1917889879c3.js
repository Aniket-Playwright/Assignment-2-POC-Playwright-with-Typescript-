...
function AttributeNewForm({ action, gridUrl }) {
    return (react.createElement(Form, { action: action, method: "POST", id: "attributeNewForm", onSuccess: (response) => {
            react_toastify_esm/* toast */.oR.success('Attribute created successfully!');
            setTimeout(() => {
...
common_Area.defaultProps.components = {
  ...
  content: {
    ...
    e7467c29bcb19f4e03188997b8395bc01: {
      id: 'e7467c29bcb19f4e03188997b8395bc01',
      sortOrder: 10,
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(45167)))
