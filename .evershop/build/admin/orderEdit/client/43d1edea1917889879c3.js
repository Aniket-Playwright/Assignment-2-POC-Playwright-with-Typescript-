...
;// ./node_modules/@evershop/evershop/dist/modules/cod/pages/admin/orderEdit/CaptureButton.js
...
function CaptureButton({ captureAPI, order: { paymentStatus, uuid, paymentMethod } }) {
    const [isLoading, setIsLoading] = react.useState(false);
    const onAction = async () => {
        setIsLoading(true);
        // Use Axios to call the capture API
        const response = await axios/* default */.A.post(captureAPI, { order_id: uuid }, { validateStatus: false });
        if (!response.data.error) {
            // Reload the page
            window.location.reload();
        }
        else {
            react_toastify_esm/* toast */.oR.error(response.data.error.message);
        }
        setIsLoading(false);
    };
    return (react.createElement(RenderIfTrue, { condition: paymentStatus.code === 'pending' && paymentMethod === 'cod' },
        react.createElement(Card.Session, null,
            react.createElement("div", { className: "flex justify-end" },
                react.createElement(common_Button, { title: "Capture", onAction: onAction, isLoading: isLoading })))));
}
CaptureButton.propTypes = {
    captureAPI: (prop_types_default()).string.isRequired,
    order: prop_types_default().shape({
        ...
        paymentMethod: (prop_types_default()).string.isRequired
    }).isRequired
};
const CaptureButton_layout = {
    areaId: 'orderPaymentActions',
    sortOrder: 10
};
const CaptureButton_query = (/* unused pure expression or super */ null && (`
  query Query {
...
// EXTERNAL MODULE: ./node_modules/luxon/src/luxon.js + 22 modules
var luxon = __webpack_require__(6685);
;// ./node_modules/@evershop/evershop/dist/modules/oms/pages/admin/orderEdit/Activities.js




function Activities({ order: { activities = [] } }) {
    ...
    activities.forEach((element) => {
        ...
        else if (luxon/* DateTime */.c9.fromSQL(element.createdAt.value).startOf('day') ===
            luxon/* DateTime */.c9.fromSQL(current.time).startOf('day')) {
...
Activities.propTypes = {
    order: prop_types_default().shape({
        activities: prop_types_default().arrayOf(prop_types_default().shape({
            comment: (prop_types_default()).string,
            customerNotified: (prop_types_default()).number,
...
const Activities_layout = {
    areaId: 'leftSide',
    sortOrder: 30
};
const Activities_query = (/* unused pure expression or super */ null && (`
  query Query {
    order(uuid: getContextValue("orderId")) {
      activities {
        comment
...
;// ./node_modules/@evershop/evershop/dist/modules/oms/pages/admin/orderEdit/AddTrackingButton.js
...
function AddTrackingButton({ order: { shipment }, carriers }) {
    ...
    if (!shipment) {
        ...
        return (react.createElement(react.Fragment, null,
            react.createElement(common_Button, { title: "Edit Tracking Info", variant: "primary", onAction: () => {
                    modal.open();
                } }),
            react.createElement(Modal, { title: "Edit Tracking Information", onClose: modal.close, isOpen: modal.isOpen },
                react.createElement(Form, { form: form, id: "editTrackingInfo", method: "PATCH", action: shipment.updateShipmentApi, submitBtn: false, onSuccess: () => {
                    ...
                    react.createElement("div", { className: "flex justify-end" },
                        react.createElement("div", { className: "grid grid-cols-2 gap-2" },
                            react.createElement(common_Button, { title: "Cancel", variant: "danger", onAction: modal.close }),
                            react.createElement(common_Button, { title: "Save", variant: "primary", isLoading: form.formState.isSubmitting, onAction: async () => {
                                    document.getElementById('editTrackingInfo').dispatchEvent(new Event('submit', { cancelable: true, bubbles: true }));
                                } })))))));
    }
}
const AddTrackingButton_layout = {
    areaId: 'order_actions',
    sortOrder: 5
};
const AddTrackingButton_query = (/* unused pure expression or super */ null && (`
  query Query {
    order(uuid: getContextValue("orderId")) {
      shipment {
        shipmentId
...
;// ./node_modules/@evershop/evershop/dist/modules/oms/pages/admin/orderEdit/CancelButton.js
...
function CancelButton({ order: { cancelApi, paymentStatus, shipmentStatus } }) {
    const modal = useModal();
    const form = (0,index_esm/* useForm */.mN)();
    return (react.createElement(RenderIfTrue, { condition: paymentStatus.isCancelable !== false &&
            shipmentStatus.isCancelable !== false },
        react.createElement(common_Button, { title: "Cancel Order", variant: "danger", onAction: () => {
                modal.open();
            } }),
        react.createElement(Modal, { title: "Cancel Order", onClose: modal.close, isOpen: modal.isOpen },
            react.createElement(Form, { form: form, id: "cancelReason", method: "POST", action: cancelApi, submitBtn: false, onSuccess: (response) => {
                    if (response.error) {
                ...
                react.createElement("div", null,
                    react.createElement(TextareaField, { name: "reason", label: "Reason for cancellation", placeholder: "Reason for cancellation", required: true, validation: {
                            required: 'Reason is required'
                        } })),
                react.createElement("div", { className: "flex justify-end" },
                    react.createElement("div", { className: "grid grid-cols-2 gap-2" },
                        react.createElement(common_Button, { title: "Cancel", variant: "danger", onAction: modal.close }),
                        react.createElement(common_Button, { title: "Submit Cancellation", variant: "primary", isLoading: form.formState.isSubmitting, onAction: async () => {
                                document.getElementById('cancelReason').dispatchEvent(new Event('submit', { cancelable: true, bubbles: true }));
                            } })))))));
}
const CancelButton_layout = {
    areaId: 'pageHeadingRight',
    sortOrder: 35
};
const CancelButton_query = (/* unused pure expression or super */ null && (`
  query Query {
    order(uuid: getContextValue("orderId")) {
      paymentStatus {
        code
...
;// ./node_modules/@evershop/evershop/dist/modules/oms/pages/admin/orderEdit/Customer.js




function Customer({ order: { shippingAddress, billingAddress, customerFullName, customerEmail, customerUrl } }) {
...
Customer.propTypes = {
    order: prop_types_default().shape({
        customerFullName: (prop_types_default()).string.isRequired,
        customerEmail: (prop_types_default()).string.isRequired,
        customerUrl: (prop_types_default()).string,
...
const Customer_query = (/* unused pure expression or super */ null && (`
  query Query {
    order(uuid: getContextValue("orderId")) {
      customerFullName
      customerEmail
...
;// ./node_modules/@evershop/evershop/dist/modules/oms/pages/admin/orderEdit/CustomerNotes.js




function CustomerNotes({ order: { shippingNote } }) {
    return (react.createElement(Card, { title: "Customer notes" },
        react.createElement(Card.Session, null,
            react.createElement(common_Area, { id: "orderEditCustomerNotes", coreComponents: [
                    {
                        component: {
...
const CustomerNotes_layout = {
    areaId: 'rightSide',
    sortOrder: 10
};
const CustomerNotes_query = (/* unused pure expression or super */ null && (`
  query Query {
    order(uuid: getContextValue("orderId")) {
      shippingNote
    }
...
;// ./node_modules/@evershop/evershop/dist/components/admin/Circle.js
...
;// ./node_modules/@evershop/evershop/dist/modules/oms/pages/admin/orderEdit/items/ItemVariantOptions.js
    ...
    return (react.createElement("div", { className: "cart-item-variant-options mt-2" },
        react.createElement("ul", null, options.map((o, i) => (react.createElement("li", { key: i },
            react.createElement("span", { className: "attribute-name font-semibold" },
                ...
                ":",
                ' '),
            react.createElement("span", null, o.optionText)))))));
}
//# sourceMappingURL=ItemVariantOptions.js.map
;// ./node_modules/@evershop/evershop/dist/modules/oms/pages/admin/orderEdit/items/Name.js


function Name({ name, productSku, productUrl, variantOptions = [] }) {
...
;// ./node_modules/@evershop/evershop/dist/modules/oms/pages/admin/orderEdit/items/Price.js
...
;// ./node_modules/@evershop/evershop/dist/modules/oms/pages/admin/orderEdit/items/Thumbnail.js
...
;// ./node_modules/@evershop/evershop/dist/modules/oms/pages/admin/orderEdit/Items.js
...
function Items({ order: { items, shipmentStatus } }) {
    return (react.createElement(Card, { title: react.createElement("div", { className: "flex space-x-2" },
        ...
        react.createElement(Card.Session, null,
            react.createElement("table", { className: "listing order-items" },
                react.createElement("tbody", null, items.map((i, k) => (react.createElement("tr", { key: k },
                    react.createElement(common_Area, { key: k, id: `order_item_row_${i.id}`, noOuter: true, item: i, coreComponents: [
                            {
        ...
        react.createElement(Card.Session, null,
            react.createElement("div", { className: "flex justify-end gap-2" },
                react.createElement(common_Area, { id: "order_actions", noOuter: true })))));
}
Items.propTypes = {
    order: prop_types_default().shape({
        items: prop_types_default().arrayOf(prop_types_default().shape({
            ...
            productSku: (prop_types_default()).string,
        ...
        shipmentStatus: prop_types_default().shape({
            ...
            badge: (prop_types_default()).string,
            progress: (prop_types_default()).string,
            name: (prop_types_default()).string
        }),
        shipment: prop_types_default().shape({
            shipmentId: (prop_types_default()).string,
            carrier: (prop_types_default()).string,
            trackingNumber: (prop_types_default()).string,
            updateShipmentApi: (prop_types_default()).string
        }),
...
const Items_query = (/* unused pure expression or super */ null && (`
  query Query {
    order(uuid: getContextValue("orderId")) {
      currency
      shipment {
...
;// ./node_modules/@evershop/evershop/dist/modules/oms/pages/admin/orderEdit/Layout.js
...
const orderEdit_Layout_layout = {
    areaId: 'content',
    sortOrder: 10
};
//# sourceMappingURL=Layout.js.map
;// ./node_modules/@evershop/evershop/dist/modules/oms/pages/admin/orderEdit/MarkDeliveredButton.js




function MarkDeliveredButton({ order: { orderId, shipmentStatus: { code }, shipment }, markDeliveredApi }) {
    if (!shipment || code === 'delivered') {
        return null;
    }
    else {
        return (react.createElement(common_Button, { title: "Mark Delivered", variant: "primary", onAction: async () => {
...
MarkDeliveredButton.propTypes = {
    order: prop_types_default().shape({
        ...
        shipment: prop_types_default().shape({
            shipmentId: (prop_types_default()).number
        })
    }).isRequired,
    markDeliveredApi: (prop_types_default()).string.isRequired
};
const MarkDeliveredButton_layout = {
    areaId: 'order_actions',
    sortOrder: 10
};
const MarkDeliveredButton_query = (/* unused pure expression or super */ null && (`
  query Query {
    order(uuid: getContextValue("orderId")) {
      orderId
      shipmentStatus {
...
;// ./node_modules/@evershop/evershop/dist/modules/oms/pages/admin/orderEdit/PageHeading.js


function OrderEditPageHeading({ backUrl, order }) {
...
`));
//# sourceMappingURL=PageHeading.js.map
;// ./node_modules/@evershop/evershop/dist/modules/oms/pages/admin/orderEdit/payment/Discount.js
...
;// ./node_modules/@evershop/evershop/dist/modules/oms/pages/admin/orderEdit/payment/Shipping.js
...
;// ./node_modules/@evershop/evershop/dist/modules/oms/pages/admin/orderEdit/payment/SubTotal.js
...
;// ./node_modules/@evershop/evershop/dist/modules/oms/pages/admin/orderEdit/payment/Tax.js
...
;// ./node_modules/@evershop/evershop/dist/modules/oms/pages/admin/orderEdit/payment/Total.js
...
;// ./node_modules/@evershop/evershop/dist/modules/oms/pages/admin/orderEdit/Payment.js
...
function OrderSummary({ order: { orderId, coupon, shippingMethodName, paymentMethodName, totalQty, totalTaxAmount, discountAmount, grandTotal, subTotal, shippingFeeInclTax, currency, paymentStatus } }) {
    return (react.createElement(Card, { title: react.createElement("div", { className: "flex space-x-2" },
        ...
        react.createElement(Card.Session, null,
            react.createElement(common_Area, { id: "orderSummaryBlock", orderId: orderId, currency: currency, grandTotal: grandTotal, coupon: coupon, discountAmount: discountAmount, totalTaxAmount: totalTaxAmount, className: "summary-wrapper", coreComponents: [
                    {
        ...
        react.createElement(common_Area, { id: "orderPaymentActions" })));
}
OrderSummary.propTypes = {
    order: prop_types_default().shape({
        orderId: (prop_types_default()).string.isRequired,
        totalQty: (prop_types_default()).number.isRequired,
        coupon: (prop_types_default()).string,
        shippingMethod: (prop_types_default()).string,
        paymentMethodName: (prop_types_default()).string,
...
const Payment_query = (/* unused pure expression or super */ null && (`
  query Query {
    order(uuid: getContextValue("orderId")) {
      orderId
      totalQty
...
;// ./node_modules/@evershop/evershop/dist/modules/oms/pages/admin/orderEdit/ShipButton.js
...
function ShipButton({ order: { shipment, createShipmentApi, shipmentStatus }, carriers }) {
    ...
    if (shipment) {
        ...
        return (react.createElement(RenderIfTrue, { condition: shipmentStatus.code !== 'canceled' },
            react.createElement(common_Button, { title: "Ship Items", variant: "primary", onAction: () => {
                    openAlert({
                        heading: 'Ship Items',
...
const ShipButton_layout = {
    areaId: 'order_actions',
    sortOrder: 10
};
const ShipButton_query = (/* unused pure expression or super */ null && (`
  query Query {
    order(uuid: getContextValue("orderId")) {
      shipment {
        shipmentId
...
;// ./node_modules/@evershop/evershop/dist/components/admin/Badge.js


function Badge({ title, variant = 'default', progress = 'default' }) {
    const badgeVariant = [
        'default',
        'success',
        'info',
...
;// ./node_modules/@evershop/evershop/dist/modules/oms/pages/admin/orderEdit/Status.js



function Status({ order: { status } }) {
    if (status) {
...
Status.propTypes = {
    order: prop_types_default().shape({
        status: prop_types_default().shape({
            badge: (prop_types_default()).string,
            name: (prop_types_default()).string,
            progress: (prop_types_default()).string
        })
...
;// ./node_modules/@evershop/evershop/dist/modules/oms/pages/admin/orderEdit/TrackingButton.js



function TrackingButton({ order: { shipment }, carriers }) {
    ...
    return (react.createElement(common_Button, { title: "Track shipment", variant: "primary", onAction: () => {
...
TrackingButton.propTypes = {
    ...
    carriers: prop_types_default().arrayOf(prop_types_default().shape({
        name: (prop_types_default()).string,
        code: (prop_types_default()).string,
        trackingUrl: (prop_types_default()).string
    })).isRequired
};
const TrackingButton_layout = {
    areaId: 'order_actions',
    sortOrder: 15
};
const TrackingButton_query = (/* unused pure expression or super */ null && (`
  query Query {
    order(uuid: getContextValue("orderId")) {
      shipment {
        shipmentId
...
;// ./node_modules/@evershop/evershop/dist/modules/paypal/pages/admin/orderEdit/PaypalCaptureButton.js
...
function PaypalCaptureButton({ captureAPI, order: { paymentStatus, uuid, paymentMethod } }) {
    const [isLoading, setIsLoading] = react.useState(false);
    const onAction = async () => {
        try {
            setIsLoading(true);
            // Use Axios to call the capture API
            const response = await axios/* default */.A.post(captureAPI, { order_id: uuid });
            if (!response.data.error) {
                // Reload the page
                window.location.reload();
            }
...
const PaypalCaptureButton_layout = {
    areaId: 'orderPaymentActions',
    sortOrder: 10
};
const PaypalCaptureButton_query = (/* unused pure expression or super */ null && (`
  query Query {
...
;// ./node_modules/@evershop/evershop/dist/modules/stripe/pages/admin/orderEdit/StripeCaptureButton.js
...
function StripeCaptureButton({ captureAPI, order: { paymentStatus, uuid, paymentMethod } }) {
    const [isLoading, setIsLoading] = react.useState(false);
    const onAction = async () => {
        setIsLoading(true);
        // Use Axios to call the capture API
...
const StripeCaptureButton_layout = {
    areaId: 'orderPaymentActions',
    sortOrder: 10
};
const StripeCaptureButton_query = (/* unused pure expression or super */ null && (`
  query Query {
...
;// ./node_modules/@evershop/evershop/dist/modules/stripe/pages/admin/orderEdit/StripeRefundButton.js
...
function StripeRefundButton({ refundAPI, order: { paymentStatus, orderId, paymentMethod, grandTotal } }) {
    const { openAlert, closeAlert, dispatchAlert } = useAlertContext();
    return (react.createElement(RenderIfTrue, { condition: paymentMethod === 'stripe' &&
            ['paid', 'partial_refunded'].includes(paymentStatus.code) },
        react.createElement(Card.Session, null,
            react.createElement("div", { className: "flex justify-end" },
                react.createElement(common_Button, { title: "Refund", variant: "secondary", onAction: () => {
                        openAlert({
                            heading: 'Refund',
                            content: (react.createElement("div", null,
...
const StripeRefundButton_layout = {
    areaId: 'orderPaymentActions',
    sortOrder: 10
};
const StripeRefundButton_query = (/* unused pure expression or super */ null && (`
  query Query {
...
;// ./.evershop/build/admin/orderEdit/client/entry.js
...
common_Area.defaultProps.components = {
  ...
  pageHeadingRight: {
    eff962c485bc99c54aeb0069bf55608de: {
      ...
      sortOrder: 35,
      component: { default: CancelButton }
    }
  },
  rightSide: {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(85182)))
