...
;// ./node_modules/@evershop/evershop/dist/modules/catalog/pages/admin/categoryGrid/rows/CategoryName.js
...
;// ./node_modules/@evershop/evershop/dist/modules/catalog/pages/admin/categoryGrid/Grid.js
...
function Actions({ categories = [], selectedIds = [] }) {
    ...
    const deleteCategories = async () => {
        ...
        const promises = categories
            ...
            .map((category) => axios/* default */.A.delete(category.deleteApi));
...
function CategoryGrid({ categories: { items: categories, total, currentFilters = [] } }) {
    var _a;
        ...
        react.createElement("table", { className: "listing sticky" },
            react.createElement("thead", null,
                react.createElement("tr", null,
                    ...
                    react.createElement(common_Area, { className: "", id: "categoryGridHeader", noOuter: true, coreComponents: [
                            {
                                component: {
            ...
            react.createElement("tbody", null,
                ...
                categories.map((c) => (react.createElement("tr", { key: c.categoryId },
                    ...
                    react.createElement(common_Area, { className: "", id: "categoryGridRow", row: c, noOuter: true, coreComponents: [
                            {
                                component: {
                            ...
                            {
                                component: {
                                    default: () => react.createElement("td", null, c.includeInNav ? 'Yes' : 'No')
                                },
                                sortOrder: 30
                            }
                        ] })))))),
...
;// ./node_modules/@evershop/evershop/dist/modules/catalog/pages/admin/categoryGrid/NewCategoryButton.js



function NewCategoryButton({ newCateoryUrl }) {
    return react.createElement(common_Button, { url: newCateoryUrl, title: "New Category" });
}
NewCategoryButton.propTypes = {
    newCateoryUrl: (prop_types_default()).string.isRequired
};
const NewCategoryButton_layout = {
    areaId: 'pageHeadingRight',
    sortOrder: 10
};
const NewCategoryButton_query = (/* unused pure expression or super */ null && (`
  query Query {
...
;// ./node_modules/@evershop/evershop/dist/modules/catalog/pages/admin/categoryGrid/PageHeading.js


function CategoryGridPageHeading() {
    return react.createElement(PageHeading, { heading: "Categories" });
}
...
;// ./.evershop/build/admin/categoryGrid/client/entry.js
...
common_Area.defaultProps.components = {
  ...
  content: {
    e584de55dfe9435212ba0fc9f7fc586cb: {
      id: 'e584de55dfe9435212ba0fc9f7fc586cb',
      sortOrder: 20,
      component: { default: CategoryGrid }
    },
    eeb5b1ad27d34cabaa54e27c37ef7e0dd: {
      id: 'eeb5b1ad27d34cabaa54e27c37ef7e0dd',
      sortOrder: 10,
      component: { default: CategoryGridPageHeading }
    }
  },
  pageHeadingRight: {
    ee4d478fbc02198984ff1c765fae1004b: {
      id: 'ee4d478fbc02198984ff1c765fae1004b',
      sortOrder: 10,
      component: { default: NewCategoryButton }
    }
  },
  settingPageMenu: {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(43216)))
