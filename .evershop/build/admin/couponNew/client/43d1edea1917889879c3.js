...
;// ./node_modules/@evershop/evershop/dist/components/common/form/ReactSelectCreatableField.js




function ReactSelectCreatableField({ name, label, error, wrapperClassName = 'form-field', helperText, required, validation, options, className, isMulti = false, defaultValue, onCreateOption, formatCreateLabel = (inputValue) => `Create "${inputValue}"`, ...selectProps }) {
    const { control, unregister } = (0,index_esm/* useFormContext */.xW)();
    const fieldId = `field-${name}`;
    ...
    return (react.createElement("div", { className: `${wrapperClassName} ${className || ''}` },
        label && (react.createElement("label", { htmlFor: fieldId },
            label,
            required && react.createElement("span", { className: "required-indicator" }, "*"))),
        react.createElement(index_esm/* Controller */.xI, { name: name, control: control, rules: validationRules, defaultValue: defaultValue, render: ({ field, fieldState }) => {
                var _a;
                ...
                const handleCreateOption = (inputValue) => {
                    ...
                    const optionExists = dynamicOptions.some((option) => option.value === newOption.value ||
                ...
                return (react.createElement("div", { className: fieldError !== undefined ? 'error' : '' },
                    react.createElement(react_select_creatable_esm/* default */.A, { ...field, ...selectProps, inputId: fieldId, options: dynamicOptions, isMulti: isMulti, formatCreateLabel: formatCreateLabel, onCreateOption: handleCreateOption, value: isMulti
                            ? dynamicOptions.filter((option) => { var _a; return (_a = field.value) === null || _a === void 0 ? void 0 : _a.includes(option.value); })
                            : dynamicOptions.find((option) => option.value === field.value) || null, onChange: (selectedOption) => {
                            if (isMulti) {
...
//# sourceMappingURL=ReactSelectCreatableField.js.map
// EXTERNAL MODULE: ./node_modules/react-select/dist/react-select.esm.js
var react_select_esm = __webpack_require__(46005);
;// ./node_modules/@evershop/evershop/dist/components/common/form/ReactSelectField.js




function ReactSelectField({ name, label, error, wrapperClassName = 'form-field', helperText, required, validation, options, className, isMulti = false, defaultValue, ...selectProps }) {
    const { control } = (0,index_esm/* useFormContext */.xW)();
    const fieldId = `field-${name}`;
    const validationRules = {
        ...validation,
        ...(required &&
    ...
    return (react.createElement("div", { className: `${wrapperClassName} ${className || ''}` },
        ...
        react.createElement(index_esm/* Controller */.xI, { name: name, control: control, rules: validationRules, defaultValue: defaultValue, render: ({ field, fieldState }) => {
                ...
                const fieldError = error || ((_a = fieldState.error) === null || _a === void 0 ? void 0 : _a.message);
                return (react.createElement("div", { className: fieldError !== undefined ? 'error' : '' },
                    react.createElement(react_select_esm/* default */.Ay, { ...field, ...selectProps, inputId: fieldId, options: options, isMulti: isMulti, value: isMulti
...
;// ./node_modules/@evershop/evershop/dist/modules/promotion/pages/admin/couponEdit+couponNew/CustomerCondition.js
...
function CustomerCondition({ coupon, groups: { items: customerGroups } }) {
    ...
    return (react.createElement(common_Area, { id: "couponCustomerCondition", coreComponents: [
            {
                component: {
...
const CustomerCondition_layout = {
    areaId: 'couponEditRight',
    sortOrder: 10
};
const CustomerCondition_query = (/* unused pure expression or super */ null && (`
  query Query {
...
;// ./node_modules/@evershop/evershop/dist/components/admin/ProductListSkeleton.js


const ProductListSkeleton = () => {
    const skeletonItems = Array(5).fill(0);
    return (react.createElement("div", { className: "product-list-skeleton" }, skeletonItems.map((_, index) => (react.createElement("div", { key: index, className: "product-skeleton-item border-b flex justify-between items-center" },
        react.createElement("div", { className: "flex items-center" },
            react.createElement("div", { className: "skeleton-image w-10 h-10 bg-gray-200 rounded skeleton-pulse mr-5" }),
            react.createElement("div", null,
...
//# sourceMappingURL=ProductListSkeleton.js.map
;// ./node_modules/@evershop/evershop/dist/components/admin/ProductSelector.js
...
const ProductSelector_SearchQuery = `
  query Query ($filters: [FilterInput!]) {
    products(filters: $filters) {
      items {
        productId
...
const ProductSelector = ({ onSelect, onUnSelect, selectedProducts }) => {
    ...
    const [result, reexecuteQuery] = (0,urql_es/* useQuery */.IT)({
        query: ProductSelector_SearchQuery,
        variables: {
            filters: inputValue
                ? [
                ...
                return (react.createElement("div", { key: product.uuid, className: "grid grid-cols-8 gap-5 py-2 border-divider items-center" },
                    ...
                    react.createElement("div", { className: "col-span-2 text-right" },
                        ...
                        isProductSelected(product, internalSelectedProducts) && (react.createElement("a", { className: "button primary", href: "#", onClick: (e) => {
                            ...
                            react.createElement(CheckIcon/* default */.A, { width: '1.2rem', height: '1.2rem' }))))));
            }))),
...
;// ./node_modules/@evershop/evershop/dist/modules/promotion/pages/admin/couponEdit+couponNew/components/BuyXGetY.js
...
const BuyXGetYList = ({ requireProducts }) => {
    const { unregister } = (0,index_esm/* useFormContext */.xW)();
    const { fields, append, remove, update, replace } = (0,index_esm/* useFieldArray */.jz)({
        name: 'buyx_gety'
    });
    (0,react.useEffect)(() => {
...
const BuyXGetY = ({ requireProducts }) => {
    const { watch } = (0,index_esm/* useFormContext */.xW)();
...
;// ./node_modules/@evershop/evershop/dist/modules/promotion/pages/admin/couponEdit+couponNew/components/conditionCriterias.js
var Operator;
(function (Operator) {
    Operator["EQUAL"] = "=";
    Operator["NOT_EQUAL"] = "!=";
...
//# sourceMappingURL=conditionCriterias.js.map
;// ./node_modules/@evershop/evershop/dist/components/admin/AttributeGroupSelector.js
...
const AttributeGroupSelector_SearchQuery = `
  query Query ($filters: [FilterInput!]) {
...
const AttributeGroupSelector = ({ onSelect, onUnSelect, selectedAttributeGroups }) => {
    ...
    const [page, setPage] = react.useState(1);
    const [result, reexecuteQuery] = (0,urql_es/* useQuery */.IT)({
        query: AttributeGroupSelector_SearchQuery,
        variables: {
            filters: inputValue
                ? [
...
;// ./node_modules/@evershop/evershop/dist/modules/promotion/pages/admin/couponEdit+couponNew/components/AttributeGroupConditionValueSelector.js




const AttributeGroupConditionValueSelector = ({ selectedValues, updateCondition, isMulti }) => {
    ...
    return (react.createElement("div", null,
        react.createElement("a", { href: "#", className: "text-interactive hover:underline", onClick: (e) => {
            ...
            selectedIds.current.map((id, index) => (react.createElement("span", { key: id },
                ...
                index === 1 && (react.createElement("span", null,
                    " and ",
                    selectedIds.current.length - 1,
                    " more"))))),
            selectedIds.current.length === 0 && (react.createElement("span", null, "Choose Attribute Groups"))),
        react.createElement(Modal, { title: "Select Attribute Groups", onClose: modal.close, isOpen: modal.isOpen },
            react.createElement("div", { className: "overflow-auto", style: { maxHeight: '60vh' } },
                react.createElement(AttributeGroupSelector, { onSelect: onSelect, onUnSelect: onUnSelect, selectedAttributeGroups: selectedIds.current.map((id) => ({
                        attributeGroupId: id,
                        uuid: undefined
                    })) })))));
};
//# sourceMappingURL=AttributeGroupConditionValueSelector.js.map
...
const CategorySelector_SearchQuery = `
  query Query ($filters: [FilterInput!]) {
...
const CategorySelector = ({ onSelect, onUnSelect, selectedCategories }) => {
    ...
    const [page, setPage] = react.useState(1);
    const [result, reexecuteQuery] = (0,urql_es/* useQuery */.IT)({
        query: CategorySelector_SearchQuery,
        variables: {
            filters: inputValue
                ? [
                    { key: 'name', operation: 'like', value: inputValue },
...
;// ./node_modules/@evershop/evershop/dist/modules/promotion/pages/admin/couponEdit+couponNew/components/CategoryConditionValueSelector.js




const CategoryConditionValueSelector = ({ selectedValues, updateCondition, isMulti }) => {
        ...
        react.createElement("a", { href: "#", className: "text-interactive hover:underline", onClick: (e) => {
            ...
            selectedIds.current.map((id, index) => (react.createElement("span", { key: id },
                ...
                index === 1 && (react.createElement("span", null,
                    ...
                    selectedIds.current.length - 1,
                    " more"))))),
            selectedIds.current.length === 0 && react.createElement("span", null, "Choose Categories")),
        react.createElement(Modal, { title: "Select Categories", onClose: modal.close, isOpen: modal.isOpen },
            react.createElement("div", { className: "overflow-auto", style: { maxHeight: '60vh' } },
                react.createElement(CategorySelector, { onSelect: onSelect, onUnSelect: onUnSelect, selectedCategories: selectedIds.current.map((id) => ({
                        categoryId: id,
                        uuid: undefined
                    })) })))));
};
//# sourceMappingURL=CategoryConditionValueSelector.js.map
;// ./node_modules/@evershop/evershop/dist/components/admin/CollectionSelector.js





const CollectionSelector_SearchQuery = `
  query Query ($filters: [FilterInput!]) {
...
const CollectionListSkeleton = () => {
    const skeletonItems = Array(5).fill(0);
    return (react.createElement("div", { className: "collection-list-skeleton" }, skeletonItems.map((_, index) => (react.createElement("div", { key: index, className: "collection-skeleton-item border-b flex justify-between items-center" },
        react.createElement("div", { className: "flex items-center" },
            react.createElement("div", null,
                react.createElement("div", { className: "skeleton-title h-5 w-30 bg-gray-200 rounded skeleton-pulse mb-2" }),
                react.createElement("div", { className: "skeleton-id h-4 w-20 bg-gray-200 rounded skeleton-pulse" }))),
...
const isCollectionSelected = (collection, selectedCollections) => {
    return selectedCollections.some((selected) => ((selected === null || selected === void 0 ? void 0 : selected.collectionId) &&
        selected.collectionId === collection.collectionId) ||
        ((selected === null || selected === void 0 ? void 0 : selected.uuid) && selected.uuid === collection.uuid));
};
const CollectionSelector = ({ onSelect, onUnSelect, selectedCollections }) => {
    ...
    const [page, setPage] = react.useState(1);
    const [result, reexecuteQuery] = (0,urql_es/* useQuery */.IT)({
        query: CollectionSelector_SearchQuery,
        variables: {
            filters: inputValue
                ? [
                    { key: 'name', operation: 'like', value: inputValue },
    ...
    return (react.createElement("div", null,
        react.createElement("div", null,
            react.createElement("div", { className: "p-2" },
                react.createElement("div", { className: "form-field" },
                    react.createElement("input", { type: "text", value: inputValue || '', placeholder: "Search collections", onChange: (e) => {
                            setInputValue(e.target.value);
                            setLoading(true);
                        } }))),
            (fetching || loading) && react.createElement(CollectionListSkeleton, null),
            !fetching && data && (react.createElement("div", { className: "divide-y" },
                ...
                data.collections.items.map((c) => (react.createElement("div", { key: c.uuid, className: "grid grid-cols-8 gap-5 py-2 border-divider items-center" },
                    react.createElement("div", { className: "col-span-5" },
                        react.createElement("h3", null, c.name)),
                    react.createElement("div", { className: "col-span-3 text-right" },
                        !isCollectionSelected(c, internalSelectedCollections) && (react.createElement("button", { type: "button", className: "button secondary", onClick: async (e) => {
                                e.preventDefault();
                        ...
                        isCollectionSelected(c, internalSelectedCollections) && (react.createElement("a", { className: "button primary", href: "#", onClick: (e) => {
                                e.preventDefault();
                                setInternalSelectedCollections((prev) => prev.filter((c) => c.collectionId !== c.collectionId &&
                                    c.uuid !== c.uuid));
                                onUnSelect(c.collectionId, c.uuid, c.name);
                            } },
                            react.createElement(CheckIcon/* default */.A, { width: 20, height: 20 })))))))))),
        react.createElement("div", { className: "flex justify-between gap-5" },
            react.createElement(SimplePagination, { total: (data === null || data === void 0 ? void 0 : data.collections.total) || 0, count: ((_b = (_a = data === null || data === void 0 ? void 0 : data.collections) === null || _a === void 0 ? void 0 : _a.items) === null || _b === void 0 ? void 0 : _b.length) || 0, page: page, hasNext: limit * page < (data === null || data === void 0 ? void 0 : data.collections.total), setPage: setPage }))));
};

//# sourceMappingURL=CollectionSelector.js.map
;// ./node_modules/@evershop/evershop/dist/modules/promotion/pages/admin/couponEdit+couponNew/components/CollectionConditionValueSelector.js




const CollectionConditionValueSelector = ({ selectedValues, updateCondition, isMulti }) => {
    const selectedIds = react.useRef(Array.isArray(selectedValues) ? selectedValues.map(Number) : []);
    const modal = useModal({
        onAfterClose: () => {
            updateCondition(selectedIds.current);
        ...
        react.createElement("a", { href: "#", className: "text-interactive hover:underline", onClick: (e) => {
            ...
            selectedIds.current.map((id, index) => (react.createElement("span", { key: id },
                ...
                index === 1 && (react.createElement("span", null,
                    ...
                    selectedIds.current.length - 1,
                    " more"))))),
            selectedIds.current.length === 0 && react.createElement("span", null, "Choose Collections")),
        react.createElement(Modal, { title: "Select Products", onClose: modal.close, isOpen: modal.isOpen },
            react.createElement("div", { className: "overflow-auto", style: { maxHeight: '60vh' } },
                react.createElement(CollectionSelector, { onSelect: onSelect, onUnSelect: onUnSelect, selectedCollections: selectedIds.current.map((id) => ({
                        collectionId: id,
                        uuid: undefined
                    })) })))));
};
//# sourceMappingURL=CollectionConditionValueSelector.js.map
;// ./node_modules/@evershop/evershop/dist/modules/promotion/pages/admin/couponEdit+couponNew/components/PriceConditionValueSelector.js


const PriceConditionValueSelector = ({ updateCondition, condition }) => {
    return (react.createElement("div", null,
        react.createElement(NumberField, { name: `dummy__` + Math.random().toString(36).substring(2, 15), wrapperClassName: "form-field mb-0", defaultValue: condition.value, placeholder: "Value", required: true, validation: {
                required: 'Value is required'
            }, onChange: (value) => {
                updateCondition(value || 0);
            } })));
};
//# sourceMappingURL=PriceConditionValueSelector.js.map
;// ./node_modules/@evershop/evershop/dist/modules/promotion/pages/admin/couponEdit+couponNew/components/SkuConditionValueSelector.js




const SkuConditionValueSelector = ({ selectedValues, updateCondition, isMulti }) => {
    const skus = Array.isArray(selectedValues) ? selectedValues : [];
    ...
    return (react.createElement("div", null,
        react.createElement("a", { href: "#", className: "text-interactive hover:underline", onClick: (e) => {
            ...
            selectedSKUs.current.map((sku, index) => (react.createElement("span", { key: sku },
                index === 0 && react.createElement("span", { className: "italic" },
                    "\u2018",
                    sku,
                    "\u2019"),
                index === 1 && (react.createElement("span", null,
                    " and ",
                    selectedSKUs.current.length - 1,
                    " more"))))),
            selectedSKUs.current.length === 0 && react.createElement("span", null, "Choose SKUs")),
        react.createElement(Modal, { title: "Select Products", onClose: modal.close, isOpen: modal.isOpen },
            react.createElement("div", { className: "overflow-auto", style: { maxHeight: '60vh' } },
                react.createElement(ProductSelector, { onSelect: onSelect, onUnSelect: onUnSelect, selectedProducts: selectedSKUs.current.map((sku) => ({
                        sku,
                        uuid: undefined,
                        productId: undefined
                    })) })))));
};
//# sourceMappingURL=SkuConditionValueSelector.js.map
;// ./node_modules/@evershop/evershop/dist/modules/promotion/pages/admin/couponEdit+couponNew/components/ValueSelector.js
...
const ValueSelector = ({ condition, updateCondition }) => {
    switch (condition.key) {
        case 'category':
            return (react.createElement(CategoryConditionValueSelector, { selectedValues: Array.isArray(condition.value) ? condition.value.map(Number) : [], updateCondition: updateCondition, isMulti: condition.operator === Operator.IN ||
                    condition.operator === Operator.NOT_IN }));
        case 'collection':
            return (react.createElement(CollectionConditionValueSelector, { selectedValues: Array.isArray(condition.value) ? condition.value.map(Number) : [], updateCondition: updateCondition, isMulti: condition.operator === Operator.IN ||
                    condition.operator === Operator.NOT_IN }));
        case 'sku':
            return (react.createElement(SkuConditionValueSelector, { selectedValues: Array.isArray(condition.value) ? condition.value.map(String) : [], updateCondition: updateCondition, isMulti: condition.operator === Operator.IN ||
                    condition.operator === Operator.NOT_IN }));
        case 'attribute_group':
            return (react.createElement(AttributeGroupConditionValueSelector, { selectedValues: Array.isArray(condition.value) ? condition.value.map(Number) : [], updateCondition: updateCondition, isMulti: condition.operator === Operator.IN ||
                    condition.operator === Operator.NOT_IN }));
        case 'price':
            return (react.createElement(PriceConditionValueSelector, { updateCondition: updateCondition, condition: { ...condition, value: Number(condition.value) } }));
        default:
            return null;
    }
};
//# sourceMappingURL=ValueSelector.js.map
;// ./node_modules/@evershop/evershop/dist/modules/promotion/pages/admin/couponEdit+couponNew/components/TargetProducts.js
...
function Products({ targetProducts, maxQty }) {
    const { setValue, watch, unregister } = (0,index_esm/* useFormContext */.xW)();
...
function TargetProducts({ products, maxQty }) {
    const { watch } = (0,index_esm/* useFormContext */.xW)();
    const watchDiscountType = watch('discount_type');
    if (watchDiscountType !== 'fixed_discount_to_specific_products' &&
        watchDiscountType !== 'percentage_discount_to_specific_products') {
...
;// ./node_modules/@evershop/evershop/dist/modules/promotion/pages/admin/couponEdit+couponNew/DiscountType.js
...
function DiscountType({ coupon }) {
    const targetProducts = get(coupon, 'targetProducts', {});
    const buyxGety = get(coupon, 'buyxGety', []);
    return (react.createElement("div", null,
        react.createElement("div", null,
            react.createElement(common_Area, { id: "couponFormDiscountType", coreComponents: [
                    {
                        component: {
                            default: (react.createElement(RadioGroupField, { required: true, validation: { required: 'Discount type is required' }, options: [
                                    {
                                ...
                                ], defaultValue: get(coupon, 'discountType', ''), name: "discount_type" }))
                        },
                        sortOrder: 10
                    }
                ] })),
        react.createElement("div", { className: "mt-2" },
            react.createElement(TargetProducts, { products: get(targetProducts, 'products', []), maxQty: get(targetProducts, 'maxQty', 0) }),
            react.createElement(BuyXGetY, { requireProducts: buyxGety, discountType: get(coupon, 'discountType', '') }))));
}
const DiscountType_layout = {
    areaId: 'couponEditDiscountType',
    sortOrder: 30
};
const DiscountType_query = (/* unused pure expression or super */ null && (`
  query Query {
    coupon(id: getContextValue('couponId', null)) {
      discountType
      targetProducts {
...
;// ./node_modules/@evershop/evershop/dist/components/common/form/DateField.js





function DateField({ name, label, error, wrapperClassName, helperText, required, validation, className, min, max, ...props }) {
    ...
    return (react.createElement("div", { className: `form-field ${wrapperClassName}` },
        label && (react.createElement("label", { htmlFor: fieldId },
            ...
            required && react.createElement("span", { className: "required-indicator" }, "*"),
            helperText && react.createElement(Tooltip, { content: helperText, position: "top" }))),
        react.createElement("input", { id: fieldId, type: "date", min: min, max: max, ...register(name, validationRules), className: `${fieldError !== undefined ? 'error' : ''} ${className || ''}`, "aria-invalid": fieldError !== undefined ? 'true' : 'false', "aria-describedby": fieldError !== undefined ? `${fieldId}-error` : undefined, ...props }),
        fieldError && (react.createElement("p", { id: `${fieldId}-error`, className: "field-error" }, fieldError))));
}
//# sourceMappingURL=DateField.js.map
;// ./node_modules/@evershop/evershop/dist/modules/promotion/pages/admin/couponEdit+couponNew/components/Setting.js



const Setting = ({ discountAmount, startDate, endDate }) => {
    return (react.createElement("div", { className: "grid grid-cols-3 gap-5 form-field-container" },
        react.createElement("div", null,
            react.createElement(NumberField, { name: "discount_amount", defaultValue: discountAmount, placeholder: "Discount amount", required: true, label: "Discount amount", validation: {
                    required: 'Discount amount is required'
                } })),
        react.createElement("div", null,
            react.createElement(DateField, { name: "start_date", label: "Start date", placeholder: "Start date", defaultValue: startDate })),
        react.createElement("div", null,
            react.createElement(DateField, { placeholder: "End date", name: "end_date", label: "End date", defaultValue: endDate }))));
};
//# sourceMappingURL=Setting.js.map
;// ./node_modules/@evershop/evershop/dist/modules/promotion/pages/admin/couponEdit+couponNew/General.js
...
function General({ coupon }) {
    return (react.createElement(common_Area, { id: "couponFormGeneral", coreComponents: [
            {
                component: {
                    default: (react.createElement(InputField, { name: "coupon", label: "Coupon Code", defaultValue: (coupon === null || coupon === void 0 ? void 0 : coupon.coupon) || '', placeholder: "Enter coupon code", required: true, validation: {
            ...
            {
                component: {
                    default: (react.createElement(TextareaField, { name: "description", label: "Description", defaultValue: (coupon === null || coupon === void 0 ? void 0 : coupon.description) || '', placeholder: "Enter description", required: true, validation: {
            ...
            {
                component: {
                    default: (react.createElement(RadioGroupField, { name: "status", label: "Status", options: [
                            { label: 'Enabled', value: 1 },
                            { label: 'Disabled', value: 0 }
                        ], defaultValue: (coupon === null || coupon === void 0 ? void 0 : coupon.status) === 0 ? 0 : 1, required: true, validation: {
            ...
            {
                component: {
                    default: (react.createElement(CheckboxField, { name: "free_shipping", defaultValue: parseInt(get(coupon, 'freeShipping'), 10) === 1, label: "Free shipping?" }))
                },
                sortOrder: 50
            }
        ] }));
...
;// ./node_modules/@evershop/evershop/dist/modules/promotion/pages/admin/couponEdit+couponNew/components/RequireProducts.js
...
;// ./node_modules/@evershop/evershop/dist/modules/promotion/pages/admin/couponEdit+couponNew/OrderCondition.js



function OrderCondition({ coupon = {} }) {
    const condition = (coupon === null || coupon === void 0 ? void 0 : coupon.condition) || {};
    return (react.createElement("div", { className: "space-y-2" },
        react.createElement(NumberField, { name: "condition.order_total", label: "Minimum purchase amount", placeholder: "Minimum purchase amount", defaultValue: condition.orderTotal || 0, helperText: "The minimum total amount required for the order to qualify for this coupon." }),
        react.createElement(NumberField, { name: "condition.order_qty", label: "Minimum purchase qty", placeholder: "Minimum purchase quantity", defaultValue: condition.orderQty || 0, helperText: "The minimum quantity of items required in the order to qualify for this coupon.", allowDecimals: false, min: 0 }),
        react.createElement(RequiredProducts, { requiredProducts: condition.requiredProducts || [] })));
}
const OrderCondition_layout = {
    areaId: 'couponEditLeft',
    sortOrder: 10
};
const OrderCondition_query = (/* unused pure expression or super */ null && (`
  query Query {
    coupon(id: getContextValue('couponId', null)) {
      condition {
        orderTotal
...
;// ./node_modules/@evershop/evershop/dist/modules/promotion/pages/admin/couponEdit+couponNew/PageHeading.js


function CouponEditPageHeading({ backUrl, coupon }) {
...
;// ./node_modules/@evershop/evershop/dist/modules/promotion/pages/admin/couponNew/CouponNewForm.js
...
function CouponNewForm({ action, gridUrl }) {
    return (react.createElement(Form, { action: action, method: "POST", id: "couponNewForm", onSuccess: (response) => {
            react_toastify_esm/* toast */.oR.success('Coupon created successfully!');
        ...
        react.createElement("div", { className: "grid grid-cols-1 gap-5" },
            react.createElement(Card, { title: "General" },
                react.createElement(Card.Session, null,
                    react.createElement(common_Area, { id: "couponEditGeneral", noOuter: true }))),
            react.createElement(Card, { title: "Discount Type" },
                react.createElement(Card.Session, null,
                    react.createElement(common_Area, { id: "couponEditDiscountType", noOuter: true }))),
            react.createElement("div", { className: "grid grid-cols-3 gap-x-5 grid-flow-row " },
                react.createElement("div", { className: "col-span-2 grid grid-cols-1 gap-5 auto-rows-max" },
                    react.createElement(Card, { title: "Order conditions" },
                        react.createElement(Card.Session, null,
                            react.createElement(common_Area, { id: "couponEditLeft", noOuter: true, className: "col-8" })))),
                react.createElement("div", { className: "col-span-1 grid grid-cols-1 gap-5 auto-rows-max" },
                    react.createElement(Card, { title: "Customer conditions" },
                        react.createElement(Card.Session, null,
                            react.createElement(common_Area, { id: "couponEditRight", className: "col-4", noOuter: true })))))),
        react.createElement(FormButtons, { cancelUrl: gridUrl, formId: "couponNewForm" })));
}
const CouponNewForm_layout = {
    areaId: 'content',
    sortOrder: 10
};
const CouponNewForm_query = (/* unused pure expression or super */ null && (`
  query Query {
...
;// ./.evershop/build/admin/couponNew/client/entry.js
...
common_Area.defaultProps.components = {
  ...
  couponEditRight: {
    ee230baf2768b7d1abc89d61b293e5921: {
      id: 'ee230baf2768b7d1abc89d61b293e5921',
      sortOrder: 10,
      component: { default: CustomerCondition }
    }
  },
  couponEditDiscountType: {
    eb410d75eae075f47fa4ba1abd9aadcd5: {
      id: 'eb410d75eae075f47fa4ba1abd9aadcd5',
      sortOrder: 30,
      component: { default: DiscountType }
    }
  },
  couponEditGeneral: {
    ed234c9b85425c695bb1d9f0f426cdb35: {
      id: 'ed234c9b85425c695bb1d9f0f426cdb35',
      sortOrder: 10,
      component: { default: General }
    }
  },
  couponEditLeft: {
    e1727251b7c07f1830150724a6b44d708: {
      id: 'e1727251b7c07f1830150724a6b44d708',
      sortOrder: 10,
      component: { default: OrderCondition }
    }
  },
  content: {
    e5745cb18aa1414113c77b3825a3bf43a: {
      id: 'e5745cb18aa1414113c77b3825a3bf43a',
      sortOrder: 5,
      component: { default: CouponEditPageHeading }
    },
    ef977a37d5d86f91232ab5133d67a2aea: {
      id: 'ef977a37d5d86f91232ab5133d67a2aea',
      sortOrder: 10,
      component: { default: CouponNewForm }
    }
  },
  '*': {
    collection_products: {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(15470)))
