...
;// ./node_modules/@evershop/evershop/dist/modules/catalog/pages/admin/collectionEdit/CollectionEditForm.js




function CollectionEditForm({ action, gridUrl }) {
    return (react.createElement(Form, { action: action, method: "PATCH", id: "collectionEditForm", submitBtn: false },
        react.createElement("div", { className: "w-2/3", style: { margin: '0 auto' } },
            react.createElement("div", { className: "grid gap-5" },
                react.createElement(common_Area, { id: "collectionFormInner", noOuter: true })),
            react.createElement(FormButtons, { formId: "collectionEditForm", cancelUrl: gridUrl }))));
}
const CollectionEditForm_layout = {
    areaId: 'content',
    sortOrder: 10
};
const CollectionEditForm_query = (/* unused pure expression or super */ null && (`
  query Query {
...
;// ./node_modules/@evershop/evershop/dist/modules/catalog/pages/admin/collectionEdit/Products.js
...
`;
function Products({ collection: { code, addProductApi } }) {
...
function General({ collection }) {
    const fields = [
        {
            component: {
                default: (react.createElement(InputField, { name: "name", label: "Collection Name", placeholder: "Enter Collection Name", defaultValue: (collection === null || collection === void 0 ? void 0 : collection.name) || '', required: true }))
            },
            sortOrder: 10,
            id: 'name'
        },
        {
            component: {
                default: (react.createElement(InputField, { name: "code", label: "Collection Code", defaultValue: (collection === null || collection === void 0 ? void 0 : collection.code) || '', validation: {
        ...
        {
            component: {
                default: (react.createElement(Editor, { name: "description", label: "Description", value: (collection === null || collection === void 0 ? void 0 : collection.description) || [] }))
            },
            sortOrder: 30
        }
    ];
...
;// ./.evershop/build/admin/collectionEdit/client/entry.js
...
common_Area.defaultProps.components = {
  ...
  content: {
    eb72332313d9d87e5a1b4dd81c0cb5925: {
      id: 'eb72332313d9d87e5a1b4dd81c0cb5925',
      sortOrder: 10,
      component: { default: CollectionEditForm }
    },
    e097d3ec70480cc70bc8e011890d083e5: {
      id: 'e097d3ec70480cc70bc8e011890d083e5',
      sortOrder: 5,
      component: { default: CollectionEditPageHeading }
    }
  },
  collectionFormInner: {
    eeed2ddf0070e65ef49921ec33546c46f: {
      id: 'eeed2ddf0070e65ef49921ec33546c46f',
      sortOrder: 20,
      component: { default: Products }
    },
    e4be303c1e7bbf8882514d3e2871ccb1d: {
      id: 'e4be303c1e7bbf8882514d3e2871ccb1d',
      sortOrder: 10,
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(31898)))
