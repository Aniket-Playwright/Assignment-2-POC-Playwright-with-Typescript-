...
function Name() {
    return (react.createElement("h1", { className: "page-name text-center mt-6 mb-4" }, "404 Page Not Found"));
}
function Content({ dashboardUrl }) {
    return (react.createElement("div", { className: "page-content" },
        ...
        react.createElement("div", { className: "mt-5 text-center" },
            react.createElement(common_Button, { title: "Back To Dashboard", url: dashboardUrl, outline: true }))));
}
function NotFound({ dashboardUrl }) {
    return (react.createElement("div", { className: "page-width mt-6" },
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(63146)))
