...
;// ./node_modules/@evershop/evershop/dist/modules/catalog/pages/admin/productEdit/Collection.js



function Collections({ product: { collections } }) {
    return (react.createElement(Card, { title: "Collections", subdued: true },
        react.createElement(Card.Session, null,
            collections.map((collection) => (react.createElement("div", { className: "flex justify-start gap-2 items-center align-middle", key: collection.uuid },
                react.createElement(TagIcon/* default */.A, { width: 16, height: 16, fill: "#2c6ecb" }),
...
const Collection_query = (/* unused pure expression or super */ null && (`
  query Query {
...
;// ./node_modules/@evershop/evershop/dist/modules/catalog/pages/admin/productEdit/ProductEditForm.js
...
function ProductEditForm({ action, gridUrl }) {
    ...
    const submit = async (data) => {
        try {
            ...
            if (result.error) {
                ...
                react_toastify_esm/* toast */.oR.success('Product updated successfully');
...
const ProductEditForm_layout = {
    areaId: 'content',
    sortOrder: 10
};
const ProductEditForm_query = (/* unused pure expression or super */ null && (`
  query Query {
...
;// ./node_modules/@evershop/evershop/dist/modules/catalog/pages/admin/productEdit/variants/CreateVariantGroup.js
...
`;
const CreateVariantGroup = ({ currentProductUuid, createVariantGroupApi, setGroup }) => {
    var _a, _b, _c;
    const [attributes, setAttributes] = react.useState([]);
    const { getValues } = (0,index_esm/* useFormContext */.xW)();
    ...
    const onCreate = async (e) => {
        ...
        if (!response.error) {
            ...
            if (addItemResponse.error) {
                react_toastify_esm/* toast */.oR.error(addItemResponse.error.message);
                return;
            }
            setGroup({
...
;// ./node_modules/@evershop/evershop/dist/modules/catalog/pages/admin/productEdit/variants/New.js



const New = ({ currentProductUuid, createVariantGroupApi, setGroup }) => {
    ...
    return (react.createElement(react.Fragment, null,
        react.createElement(Card.Session, null,
            action === undefined && (react.createElement("div", null,
                react.createElement("div", { className: "justify-center text-center" },
                    react.createElement("div", { className: "mb-10" },
                        react.createElement("span", { className: "pr-2" }, "This product has some variants like color or size?"),
            ...
            action === 'create' && (react.createElement("div", null,
                react.createElement(CreateVariantGroup, { currentProductUuid: currentProductUuid, setGroup: setGroup, createVariantGroupApi: createVariantGroupApi })))),
...
;// ./node_modules/@evershop/evershop/dist/modules/catalog/pages/admin/productEdit/variants/VariantModal.js
...
const VariantModal_AttributesQuery = `
  query Query($filters: [FilterInput]) {
    attributes(filters: $filters) {
      items {
        attributeId
...
`;
const VariantModal = ({ variant, variantGroup, createProductApi, closeModal }) => {
    var _a, _b;
    const [saving, setSaving] = (0,react.useState)(false);
    const { watch, register, control } = (0,index_esm/* useFormContext */.xW)();
    ...
    const { getValues, trigger } = (0,index_esm/* useFormContext */.xW)();
    ...
    const saveVariant = async () => {
        ...
        if (responseJson.error) {
            react_toastify_esm/* toast */.oR.error(responseJson.error.message);
        }
        else if (!variant) {
            const addVariantResponse = await addVariantItem(responseJson.data.uuid, variantGroup.addItemApi);
            if (addVariantResponse.error) {
                react_toastify_esm/* toast */.oR.error(addVariantResponse.error.message);
            }
            else {
                react_toastify_esm/* toast */.oR.success('Variant created successfully');
                closeModal();
            }
        }
        else {
            react_toastify_esm/* toast */.oR.success('Variant updated successfully');
            closeModal();
        }
        setSaving(false);
    };
    ...
    const [result] = (0,urql_es/* useQuery */.IT)({
        query: VariantModal_AttributesQuery,
        variables: {
            filters: [
                {
                    key: 'code',
        ...
        react.createElement(Card.Session, null,
            react.createElement("div", { className: "flex justify-end" },
                react.createElement("div", { className: "grid grid-cols-2 gap-2" },
                    react.createElement(common_Button, { title: "Cancel", variant: "danger", onAction: closeModal }),
                    react.createElement(common_Button, { title: "Save", variant: "primary", isLoading: saving, onAction: async () => {
...
;// ./node_modules/@evershop/evershop/dist/modules/catalog/pages/admin/productEdit/variants/CreateVariant.js





const CreateVariant = ({ variantGroup, createProductApi, refresh }) => {
    ...
    return (react.createElement("div", null,
        react.createElement("div", { className: "mt-5" },
            react.createElement(common_Button, { title: "Add Variant", onAction: () => {
                    modal.open();
                } })),
        react.createElement(Modal, { isOpen: modal.isOpen, onClose: modal.close },
            react.createElement(VariantModal, { variantGroup: variantGroup, createProductApi: createProductApi, closeModal: modal.close }))));
};
//# sourceMappingURL=CreateVariant.js.map
;// ./node_modules/@evershop/evershop/dist/modules/catalog/pages/admin/productEdit/variants/Skeleton.js

const SkeletonRow = () => (react.createElement("tr", { className: "border-b border-gray-200" },
    react.createElement("td", { className: "p-2" },
        react.createElement("div", { className: "w-7 h-7 bg-gray-200 rounded animate-pulse" })),
    react.createElement("td", { className: "p-2" },
        react.createElement("div", { className: "w-5 h-4 bg-gray-200 rounded animate-pulse" })),
    react.createElement("td", { className: "p-2" },
        react.createElement("div", { className: "w-7 h-4 bg-gray-200 rounded animate-pulse" })),
    react.createElement("td", { className: "p-2" },
        react.createElement("div", { className: "w-16 h-4 bg-gray-200 rounded animate-pulse" })),
    react.createElement("td", { className: "p-2" },
        react.createElement("div", { className: "w-10 h-4 bg-gray-200 rounded animate-pulse" })),
    react.createElement("td", { className: "p-2" },
        react.createElement("div", { className: "w-4 h-4 bg-gray-200 rounded animate-pulse" })),
    react.createElement("td", { className: "p-2" },
        react.createElement("div", { className: "w-10 h-4 bg-gray-200 rounded animate-pulse" })),
    react.createElement("td", { className: "p-2" },
        react.createElement("div", { className: "w-7 h-5 bg-gray-200 rounded animate-pulse" }))));
const Skeleton = ({ rows = 5, className = '' }) => {
    return (react.createElement("div", { className: `w-full ${className}` },
        react.createElement("table", { className: "w-full border-collapse bg-white rounded-lg shadow-sm" },
            react.createElement("tbody", null, Array.from({ length: rows }, (_, index) => (react.createElement(SkeletonRow, { key: index })))))));
};
//# sourceMappingURL=Skeleton.js.map
;// ./node_modules/@evershop/evershop/dist/modules/catalog/pages/admin/productEdit/variants/EditVariant.js




const EditVariant = ({ variant, refresh, variantGroup }) => {
    const modal = useModal({
        onAfterClose: () => {
            refresh();
        }
    ...
    return (react.createElement("div", null,
        ...
        react.createElement(Modal, { isOpen: modal.isOpen, onClose: modal.close },
            react.createElement(VariantModal, { variant: variant, variantGroup: variantGroup, closeModal: modal.close }))));
};
//# sourceMappingURL=EditVariant.js.map
;// ./node_modules/@evershop/evershop/dist/modules/catalog/pages/admin/productEdit/variants/Variant.js


const Variant = ({ variant, refresh, variantGroup }) => {
    ...
    return (react.createElement("tr", null,
        ...
        variantGroup.attributes.map((a) => {
            ...
            return (react.createElement("td", { key: a.attributeId },
        ...
        react.createElement("td", null,
            react.createElement(EditVariant, { variant: variant, refresh: refresh, variantGroup: variantGroup }))));
};
//# sourceMappingURL=Variant.js.map
;// ./node_modules/@evershop/evershop/dist/modules/catalog/pages/admin/productEdit/variants/Variants.js
...
`;
const Variants = ({ productId, variantGroup, createProductApi }) => {
    var _a;
...
const VariantGroup = ({ product, createVariantGroupApi, createProductApi }) => {
    ...
    return (react.createElement(Card, { title: "Variant" },
        !group && (react.createElement(New, { currentProductUuid: product.uuid, createVariantGroupApi: createVariantGroupApi, setGroup: setGroup })),
        group && (react.createElement(Variants, { productId: product.productId, productUuid: product.uuid, variantGroup: group, createProductApi: createProductApi }))));
};
const VariantGroup_layout = {
    areaId: 'leftSide',
    sortOrder: 70
};
const VariantGroup_query = (/* unused pure expression or super */ null && (`
query Query {
  product(id: getContextValue('productId', null)) {
    productId
    uuid
...
`));
/* harmony default export */ const productEdit_VariantGroup = (VariantGroup);
...
;// ./.evershop/build/admin/productEdit/client/entry.js
...
common_Area.defaultProps.components = {
  ...
  rightSide: {
    ecec3276064294568ff78f58bafd505d8: {
      id: 'ecec3276064294568ff78f58bafd505d8',
      sortOrder: 15,
      component: { default: Collections }
    },
  ...
  content: {
    e36fe134bd713cab9f382514b1b4fea9a: {
      id: 'e36fe134bd713cab9f382514b1b4fea9a',
      sortOrder: 10,
      component: { default: ProductEditForm }
    },
  ...
  leftSide: {
    efcbc181f59cc670acb6158ef03498c62: {
      id: 'efcbc181f59cc670acb6158ef03498c62',
      sortOrder: 70,
      component: { default: productEdit_VariantGroup }
    },
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(91470)))
