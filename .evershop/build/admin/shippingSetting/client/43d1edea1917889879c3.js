...
;// ./node_modules/@evershop/evershop/dist/components/admin/SettingMenu.js
...
var MapPinIcon = __webpack_require__(49577);
...
var CogIcon = __webpack_require__(68830);
...
;// ./node_modules/@evershop/evershop/dist/components/common/form/ToggleField.js





function ToggleField({ name, label, error, helperText, required, validation, wrapperClassName, disabled = false, defaultValue = false, trueValue = true, falseValue = false, trueLabel = 'Yes', falseLabel = 'No', size = 'md', variant = 'default', onChange }) {
    const { control, formState: { errors } } = (0,index_esm/* useFormContext */.xW)();
    const fieldError = getNestedError(name, errors, error);
    const fieldId = `field-${name}`;
    const validationRules = {
...
;// ./node_modules/@evershop/evershop/dist/components/common/form/UrlField.js





function UrlField({ name, label, error, wrapperClassName, helperText, required, validation, defaultValue, className, prefixIcon, suffixIcon, ...props }) {
    const { register, formState: { errors } } = (0,index_esm/* useFormContext */.xW)();
    const fieldError = getNestedError(name, errors, error);
    const fieldId = `field-${name}`;
...
;// ./node_modules/@evershop/evershop/dist/modules/checkout/pages/admin/shippingSetting/shippingSetting/PriceBasedPrice.js



function PriceBasedPrice({ lines }) {
    const { control } = (0,index_esm/* useFormContext */.xW)();
    const { fields, append, remove } = (0,index_esm/* useFieldArray */.jz)({
        control,
    ...
    react.useEffect(() => {
        if (fields.length === 0 && lines.length > 0) {
            lines.forEach((line) => {
                var _a, _b;
                append({
                    min_price: ((_a = line.minPrice) === null || _a === void 0 ? void 0 : _a.value) || undefined,
                    cost: ((_b = line.cost) === null || _b === void 0 ? void 0 : _b.value) || undefined
                });
            });
        }
        ...
        react.createElement("table", { className: "border-collapse divide-y" },
            ...
            react.createElement("tbody", null, fields.map((field, index) => (react.createElement("tr", { key: field.id, className: "border-divider py-5" },
                react.createElement("td", { className: "border-none" },
                    react.createElement(NumberField, { name: `price_based_cost.${index}.min_price`, placeholder: "Min Price", required: true, validation: { required: 'Min price is required' } })),
                react.createElement("td", { className: "border-none" },
                    react.createElement(NumberField, { name: `price_based_cost.${index}.cost`, placeholder: "Shipping Cost", required: true, validation: { required: 'Shipping cost is required' } })),
...
;// ./node_modules/@evershop/evershop/dist/modules/checkout/pages/admin/shippingSetting/shippingSetting/WeightBasedPrice.js



function WeightBasedPrice({ lines }) {
    const { control } = (0,index_esm/* useFormContext */.xW)();
    const { fields, append, remove } = (0,index_esm/* useFieldArray */.jz)({
        control,
...
;// ./node_modules/@evershop/evershop/dist/modules/checkout/pages/admin/shippingSetting/shippingSetting/MethodForm.js
...
function Condition({ method }) {
    ...
    const type = watch('condition_type', (method === null || method === void 0 ? void 0 : method.conditionType) || 'price');
    (0,react.useEffect)(() => {
        setValue('condition_type', (method === null || method === void 0 ? void 0 : method.conditionType) || 'price');
    }, [method]);
    return (react.createElement("div", null,
        react.createElement("div", { className: "mb-2" },
            react.createElement(RadioGroupField, { name: "condition_type", options: [
        ...
        react.createElement("div", { className: "grid grid-cols-2 gap-5" },
            react.createElement("div", null,
                react.createElement(NumberField, { name: "min", label: type === 'price' ? 'Minimum order price' : 'Minimum order weight', placeholder: type === 'price' ? 'Minimum order price' : 'Minimum order weight', defaultValue: method === null || method === void 0 ? void 0 : method.min, required: true, validation: { required: 'Min is required' }, helperText: "This is the minimum order price or weight to apply this condition." })),
            react.createElement("div", null,
                react.createElement(NumberField, { name: "max", label: type === 'price' ? 'Maximum order price' : 'Maximum order weight', placeholder: type === 'price' ? 'Maximum order price' : 'Maximum order weight', defaultValue: method === null || method === void 0 ? void 0 : method.max, validation: { required: 'Max is required' }, helperText: "This is the maximum order price or weight to apply this condition." })))));
}
...
const CostSetting = ({ method }) => {
    ...
    return (react.createElement(react.Fragment, null,
        typeWatch === 'flat_rate' && (react.createElement(NumberField, { label: "Flat rate cost", name: "cost", placeholder: "Shipping cost", required: true, validation: { required: 'Shipping cost is required' }, helperText: "This is the flat rate cost for shipping.", defaultValue: (_a = method === null || method === void 0 ? void 0 : method.cost) === null || _a === void 0 ? void 0 : _a.value })),
        typeWatch === 'price_based_rate' && (react.createElement(PriceBasedPrice, { lines: (method === null || method === void 0 ? void 0 : method.priceBasedCost) || [] })),
        typeWatch === 'weight_based_rate' && (react.createElement(WeightBasedPrice, { lines: (method === null || method === void 0 ? void 0 : method.weightBasedCost) || [] })),
        typeWatch === 'api' && (react.createElement(UrlField, { name: "calculate_api", placeholder: "Calculate API endpoint", required: true, validation: { required: 'Calculate API is required' }, defaultValue: (method === null || method === void 0 ? void 0 : method.calculateApi) || '', helperText: "This API will be called to calculate shipping cost. It supposed to return a number." }))));
};
function MethodForm({ saveMethodApi, onSuccess, reload, method }) {
    ...
    return (react.createElement(Form, { id: "shippingMethodForm", method: method ? 'PATCH' : 'POST', action: saveMethodApi, submitBtn: false, onSuccess: async (response) => {
            if (!response.error) {
                reload();
                onSuccess && onSuccess();
                react_toastify_esm/* toast */.oR.success('Shipping method saved successfully');
            }
            else {
        ...
        react.createElement(Card.Session, { title: "Method name" },
            !method ? (react.createElement(ReactSelectCreatableField, { name: "shippingMethod", isClearable: true, isDisabled: isLoading, isLoading: isLoading, onCreateOption: handleCreate, options: result.data.shippingMethods, required: true, validation: { required: 'Shipping method is required' } })) : (react.createElement("div", { className: "flex gap-2 justify-start items-center" },
                react.createElement(InputField, { name: "name", placeholder: "Method name", required: true, defaultValue: name, disabled: !updatingName, validation: { required: 'Method name is required' } }),
                updatingName && (react.createElement(common_Button, { title: "Save", variant: "primary", onAction: async () => {
            ...
            react.createElement(InputField, { type: "hidden", name: "method_id", defaultValue: (method === null || method === void 0 ? void 0 : method.uuid) || '' }),
            react.createElement(ToggleField, { name: "is_enabled", label: "Status", defaultValue: (method === null || method === void 0 ? void 0 : method.isEnabled) || 0 })),
        react.createElement(Card.Session, { title: "Setup shipping cost" },
            react.createElement(RadioGroupField, { name: "calculation_type", options: [
            ...
            react.createElement(CostSetting, { method: method || null }),
            ...
            !hasCondition && (react.createElement(InputField, { name: "condition_type", type: "hidden", value: "none" })),
            hasCondition && react.createElement(Condition, { method: method })),
        react.createElement(Card.Session, null,
            react.createElement("div", { className: "flex justify-end gap-2" },
                react.createElement(common_Button, { title: "Save", variant: "primary", onAction: () => {
...
;// ./node_modules/@evershop/evershop/dist/modules/checkout/pages/admin/shippingSetting/shippingSetting/Method.js
    ...
    return (react.createElement(react.Fragment, null,
        react.createElement(react.Fragment, null,
            ...
            react.createElement("td", { className: "border-none py-2" }, ((_a = method.cost) === null || _a === void 0 ? void 0 : _a.text) || (react.createElement("a", { href: "#", className: "text-interactive", onClick: (e) => {
                ...
                react.createElement(CogIcon/* default */.A, { width: 22, height: 22 })))),
                ...
                react.createElement("a", { href: "#", className: "text-critical ml-5", onClick: async (e) => {
                        ...
                        try {
                            ...
                            if (response.ok) {
                                reload();
                                // Toast success
                                react_toastify_esm/* toast */.oR.success('Method removed successfully');
                            }
                            else {
                                // Toast error
                                react_toastify_esm/* toast */.oR.error('Failed to remove method');
                            }
                        }
                        catch (error) {
                            // Toast error
...
;// ./node_modules/@evershop/evershop/dist/modules/checkout/pages/admin/shippingSetting/shippingSetting/Methods.js





function Methods({ reload, methods, addMethodApi }) {
    const modal = useModal();
    return (react.createElement("div", { className: "my-5" },
        react.createElement("table", { className: "border-collapse divide-y" },
            react.createElement("thead", null,
                react.createElement("tr", null,
                    ...
                    react.createElement("th", { className: "border-none" }, "Action"))),
            react.createElement("tbody", null, methods.map((method) => (react.createElement("tr", { key: method.methodId, className: "border-divider py-5" },
                react.createElement(Method, { method: method, reload: reload })))))),
        react.createElement("div", { className: "mt-2" },
            react.createElement("a", { href: "#", className: "text-interactive", onClick: (e) => {
                    e.preventDefault();
                    modal.open();
                } }, "+ Add Method")),
        react.createElement(Modal, { title: "Add Method", onClose: modal.close, isOpen: modal.isOpen },
            react.createElement(MethodForm, { saveMethodApi: addMethodApi, onSuccess: () => modal.close(), reload: reload }))));
}
...
;// ./node_modules/@evershop/evershop/dist/modules/checkout/pages/admin/shippingSetting/shippingSetting/ZoneForm.js
...
function ZoneForm({ formMethod, saveZoneApi, onSuccess, reload, zone }) {
    ...
    const [{ data, fetching, error }] = (0,urql_es/* useQuery */.IT)({
        query: CountriesQuery
    });
    if (fetching)
        return react.createElement(admin_Spinner, null);
    if (error) {
...
;// ./node_modules/@evershop/evershop/dist/modules/checkout/pages/admin/shippingSetting/shippingSetting/Zone.js
    ...
    return (react.createElement(Card.Session, { title: react.createElement("div", { className: "flex justify-between items-center gap-5" },
            ...
            react.createElement("div", { className: "flex justify-between gap-5" },
                ...
                react.createElement("a", { className: "text-critical", href: "#", onClick: async (e) => {
                        e.preventDefault();
                        try {
                            const response = await axios/* default */.A.delete(zone.deleteApi);
                            if (response.status === 200) {
                                // Toast success
                                react_toastify_esm/* toast */.oR.success('Zone removed successfully');
                                // Delay for 2 seconds
                                setTimeout(() => {
                                    // Reload page
                                ...
                                // Toast error
                                react_toastify_esm/* toast */.oR.error('Failed to remove zone');
                            }
                        }
                        catch (error) {
                            // Toast error
        ...
        react.createElement("div", { className: "divide-y border rounded border-divider" },
            react.createElement("div", { className: "flex justify-start items-center border-divider mt-5" },
                react.createElement("div", { className: "p-5" },
                    react.createElement(MapPinIcon/* default */.A, { width: 25, height: 25, fill: "#008060" })),
...
;// ./node_modules/@evershop/evershop/dist/modules/checkout/pages/admin/shippingSetting/shippingSetting/Zones.js
...
`;
function Zones({ createShippingZoneApi }) {
    const modal = useModal();
    const [{ data, fetching, error }, reexecuteQuery] = (0,urql_es/* useQuery */.IT)({
        query: ZonesQuery,
    ...
    if (fetching)
        return react.createElement(admin_Spinner, null);
    if (error)
        return react.createElement("div", null, "Error loading zones");
    if (!data || !data.shippingZones)
        return react.createElement("div", null, "No zones found");
    const reload = () => {
        reexecuteQuery({ requestPolicy: 'network-only' });
    };
    return (react.createElement(react.Fragment, null,
        data.shippingZones.map((zone) => (react.createElement(Zone, { zone: zone, reload: reload, key: zone.uuid }))),
        react.createElement("div", { className: "flex justify-end p-5" },
            react.createElement("a", { href: "#", className: "text-interactive button primary", onClick: (e) => {
                    e.preventDefault();
                    modal.open();
                } }, "Create New Zone")),
        react.createElement(Modal, { title: "Create New Shipping Zone", onClose: modal.close, isOpen: modal.isOpen },
            react.createElement(ZoneForm, { formMethod: "POST", saveZoneApi: createShippingZoneApi, onSuccess: () => {
                    modal.close();
                }, reload: reload }))));
}
//# sourceMappingURL=Zones.js.map
;// ./node_modules/@evershop/evershop/dist/modules/checkout/pages/admin/shippingSetting/ShippingSetting.js




function ShippingSetting({ createShippingZoneApi }) {
        ...
        react.createElement("div", { className: "grid grid-cols-6 gap-x-5 grid-flow-row " },
            ...
            react.createElement("div", { className: "col-span-4" },
                react.createElement(Card, null,
                    ...
                    react.createElement(Zones, { createShippingZoneApi: createShippingZoneApi }))))));
}
const ShippingSetting_layout = {
    areaId: 'content',
    sortOrder: 10
};
const ShippingSetting_query = (/* unused pure expression or super */ null && (`
  query Query {
...
var esm_CogIcon = __webpack_require__(35351);
...
function SettingMenuGroup_CmsMenuGroup({ storeSetting }) {
    return (react.createElement(NavigationItemGroup, { id: "settingMenuGroup", name: "Setting", Icon: () => react.createElement(esm_CogIcon/* default */.A, { width: 15, height: 15 }), url: storeSetting }));
}
...
;// ./.evershop/build/admin/shippingSetting/client/entry.js
...
common_Area.defaultProps.components = {
  ...
  content: {
    efcc09f7361ab4f8018552ee0ea433e1e: {
      id: 'efcc09f7361ab4f8018552ee0ea433e1e',
      sortOrder: 10,
      component: { default: ShippingSetting }
    }
  },
  footerLeft: {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(60316)))
