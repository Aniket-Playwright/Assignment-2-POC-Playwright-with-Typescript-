...
;// ./node_modules/@evershop/evershop/dist/modules/catalog/pages/admin/categoryEdit/CategoryEditForm.js




function CategoryEditForm({ action, gridUrl }) {
    return (react.createElement(Form, { action: action, method: "PATCH", id: "categoryEditForm", submitBtn: false },
        ...
        react.createElement(FormButtons, { formId: "categoryEditForm", cancelUrl: gridUrl })));
}
const CategoryEditForm_layout = {
    areaId: 'content',
    sortOrder: 10
};
const CategoryEditForm_query = (/* unused pure expression or super */ null && (`
  query Query {
...
;// ./node_modules/@evershop/evershop/dist/modules/catalog/pages/admin/categoryEdit/Products.js
...
`;
function Products({ category: { categoryId, addProductApi } }) {
    ...
    const addProductFunction = async (sku, uuid) => {
        ...
        if (!data.success) {
            react_toastify_esm/* toast */.oR.error(data.message);
        }
        else {
            reexecuteQuery({ requestPolicy: 'network-only' });
        }
    ...
    return (react.createElement(Card, { title: "Products", actions: [
        ...
        data && (react.createElement(Modal, { title: "Add Products", onClose: modal.close, isOpen: modal.isOpen },
            react.createElement(ProductSelector, { onSelect: addProductFunction, selectedProducts: data.category.products.items.map((p) => ({
                    sku: p.sku,
                    uuid: p.uuid,
        ...
        react.createElement(Card.Session, null,
            react.createElement("div", null,
                react.createElement("div", { className: "mb-5" },
                    react.createElement("div", { className: "form-field" },
                        react.createElement("input", { type: "text", value: keyword, placeholder: "Search products", onChange: (e) => {
                                setLoading(true);
                    ...
                    react.createElement("div", { className: "flex justify-between" },
                        react.createElement("div", null,
                            react.createElement("i", null,
                                ...
                                " items")),
                        react.createElement("div", null, data.category.products.total > 10 && (react.createElement("div", { className: "flex justify-between gap-2" },
                    ...
                    react.createElement("div", { className: "divide-y" }, data.category.products.items.map((p) => {
                        ...
                        return (react.createElement("div", { key: p.uuid, className: "flex justify-between py-2 border-divider items-center" },
                            ...
                            react.createElement("div", { className: "text-right" },
                                react.createElement(common_Button, { title: "Remove", variant: "danger", onAction: async () => {
...
;// ./node_modules/@evershop/evershop/dist/components/admin/CategoryTree.js
    ...
    return (react.createElement("li", { className: "[&_ul]:pl-2" },
        react.createElement("div", { className: className },
            category.hasChildren && (react.createElement("a", { href: "#", onClick: (e) => {
                ...
                } }, expanded ? (react.createElement(ChevronDownIcon/* default */.A, { width: 15, height: 15 })) : (react.createElement(ChevronRightIcon/* default */.A, { width: 15, height: 15 })))),
            !category.hasChildren && (react.createElement("span", { className: "text-gray-400" },
                react.createElement(MinusIcon/* default */.A, { width: 11, height: 15 }))),
            react.createElement("a", { href: "#", onClick: (e) => {
                    e.preventDefault();
                    onSelect(category);
                } },
                react.createElement("div", { className: "flex gap-2 justify-start items-center cursor-pointer" },
                    react.createElement(FolderIcon/* default */.A, { width: 20, height: 20 }),
...
;// ./node_modules/@evershop/evershop/dist/modules/catalog/pages/admin/categoryEdit+categoryNew/General.js
...
const ParentCategory = ({ parent }) => {
    ...
    return (react.createElement("div", { className: "mt-4 relative" },
        react.createElement("div", { className: "mb-2" }, "Parent category"),
        category && (react.createElement("div", { className: "border rounded border-[#c9cccf] mb-2 p-2" },
            ...
            react.createElement("span", { className: "text-interactive pl-5 hover:underline" },
                react.createElement("a", { href: "#", onClick: (e) => {
                        e.preventDefault();
                        modal.open();
                    } }, "Change")),
            react.createElement("span", { className: "text-critical pl-5 hover:underline" },
                react.createElement("a", { href: "#", onClick: (e) => {
                        e.preventDefault();
                        setCategory(null);
                    } }, "Unlink")))),
        ...
        react.createElement(Modal, { title: "Select a parent category", onClose: modal.close, isOpen: modal.isOpen },
            react.createElement("div", { className: "px-2" },
                react.createElement(CategoryTree, { selectedCategories: category ? [category] : [], onSelect: (c) => {
                        setCategory(c);
                        modal.close();
                    } }))),
        react.createElement(InputField, { type: "hidden", name: "parent_id", value: (category === null || category === void 0 ? void 0 : category.categoryId) || '' })));
};
function General({ category }) {
    const fields = [
        {
            component: {
                default: (react.createElement(InputField, { name: "name", label: "Category Name", placeholder: "Enter Category Name", defaultValue: (category === null || category === void 0 ? void 0 : category.name) || '', required: true, validation: {
        ...
        {
            component: {
                default: (react.createElement(Editor, { name: "description", label: "Description", value: (category === null || category === void 0 ? void 0 : category.description) || [] }))
            },
            sortOrder: 30
        }
    ];
    return (react.createElement(Card, { title: "General" },
        react.createElement(Card.Session, null,
            react.createElement(common_Area, { id: "categoryEditGeneral", coreComponents: fields }))));
}
...
;// ./node_modules/@evershop/evershop/dist/modules/catalog/pages/admin/categoryEdit+categoryNew/Image.js
...
function Image_Image({ category }) {
    const [image, setImage] = (0,react.useState)(category === null || category === void 0 ? void 0 : category.image);
    const { setValue } = (0,index_esm/* useFormContext */.xW)();
    (0,react.useEffect)(() => {
        if (image) {
    ...
    return (react.createElement(Card, { title: "Category banner" },
        react.createElement(Card.Session, null,
            react.createElement(ImageUploader, { onUpload: (images) => {
                    if (images.length > 0) {
                        setImage(images[0]);
                    }
                }, isMultiple: false, allowDelete: true, onDelete: () => {
                    setImage(undefined);
                }, currentImages: image ? [image] : [], targetPath: `catalog/${Math.floor(Math.random() * (9999 - 1000)) + 1000}/${Math.floor(Math.random() * (9999 - 1000)) + 1000}` }),
            react.createElement(InputField, { type: "hidden", defaultValue: image === null || image === void 0 ? void 0 : image.url, name: "image" }))));
}
const Image_layout = {
    areaId: 'rightSide',
    sortOrder: 10
};
const Image_query = (/* unused pure expression or super */ null && (`
  query Query {
    category(id: getContextValue("categoryId", null)) {
      image {
        id: uuid
...
;// ./node_modules/@evershop/evershop/dist/modules/catalog/pages/admin/categoryEdit+categoryNew/PageHeading.js


function CategoryEditPageHeading({ backUrl, category }) {
...
;// ./node_modules/@evershop/evershop/dist/modules/catalog/pages/admin/categoryEdit+categoryNew/Seo.js
...
function Seo({ category }) {
    const fields = [
        {
            component: {
                default: (react.createElement(InputField, { name: "url_key", label: "URL key", placeholder: "Enter URL key", defaultValue: (category === null || category === void 0 ? void 0 : category.urlKey) || '', required: true, validation: {
        ...
        {
            component: {
                default: (react.createElement(InputField, { name: "meta_title", label: "Meta title", placeholder: "Enter Meta title", defaultValue: (category === null || category === void 0 ? void 0 : category.metaTitle) || '', required: true, validation: {
        ...
        {
            component: {
                default: (react.createElement(TextareaField, { name: "meta_description", label: "Meta description", placeholder: "Enter Meta description", defaultValue: (category === null || category === void 0 ? void 0 : category.metaDescription) || '', required: true, validation: {
    ...
    return (react.createElement(Card, { title: "Search engine optimize" },
        react.createElement(Card.Session, null,
            react.createElement(common_Area, { id: "categoryEditSeo", coreComponents: fields }))));
}
const Seo_layout = {
    areaId: 'leftSide',
    sortOrder: 60
...
;// ./node_modules/@evershop/evershop/dist/modules/catalog/pages/admin/categoryEdit+categoryNew/Status.js
...
function Status({ category }) {
    ...
    return (react.createElement(Card, null,
        react.createElement(Card.Session, { title: "Status" },
            react.createElement(RadioGroupField, { name: "status", options: [
                    { label: 'Disabled', value: 0 },
                    { label: 'Enabled', value: 1 }
                ], defaultValue: (category === null || category === void 0 ? void 0 : category.status) === 0 ? 0 : 1, validation: {
                    required: 'This field is required'
                } })),
        react.createElement(Card.Session, { title: "Include In Store Menu" },
            react.createElement(RadioGroupField, { name: "include_in_nav", options: [
                    { label: 'No', value: 0 },
                    { label: 'Yes', value: 1 }
                ], defaultValue: (category === null || category === void 0 ? void 0 : category.includeInNav) === 0 ? 0 : 1, validation: {
                    required: 'This field is required'
                } })),
        react.createElement(Card.Session, { title: "Show Products?" },
            react.createElement(RadioGroupField, { name: "show_products", options: [
                    { label: 'No', value: 0 },
                    { label: 'Yes', value: 1 }
                ], defaultValue: (category === null || category === void 0 ? void 0 : category.showProducts) === 0 ? 0 : 1, validation: {
                    required: 'This field is required'
                } }))));
}
const Status_layout = {
...
;// ./.evershop/build/admin/categoryEdit/client/entry.js
...
common_Area.defaultProps.components = {
  ...
  content: {
    eee744f629893b71fca51de8d9bac1a99: {
      id: 'eee744f629893b71fca51de8d9bac1a99',
      sortOrder: 10,
      component: { default: CategoryEditForm }
    },
    e8b41ca9ccae9d25dc6020055c6aadc66: {
      id: 'e8b41ca9ccae9d25dc6020055c6aadc66',
      sortOrder: 5,
      component: { default: CategoryEditPageHeading }
    }
  },
  leftSide: {
    e2cdacaa2e53a2034c36083c53ffa82e8: {
      id: 'e2cdacaa2e53a2034c36083c53ffa82e8',
      sortOrder: 15,
      component: { default: Products }
    },
    e321c0c134d803e32e57f023a65a326af: {
      id: 'e321c0c134d803e32e57f023a65a326af',
      sortOrder: 10,
      component: { default: General }
    },
    ea6bd4ede0c4a19434a113cedc42cc803: {
      id: 'ea6bd4ede0c4a19434a113cedc42cc803',
      sortOrder: 60,
      component: { default: Seo }
    }
  },
  rightSide: {
    eaa1db0d3ce45e76c2e0769e7b9f7c3ab: {
      id: 'eaa1db0d3ce45e76c2e0769e7b9f7c3ab',
      sortOrder: 10,
      component: { default: Image_Image }
    },
    ee52960fb18c7647ff0f01163daa0c1ca: {
      id: 'ee52960fb18c7647ff0f01163daa0c1ca',
      sortOrder: 15,
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(75460)))
