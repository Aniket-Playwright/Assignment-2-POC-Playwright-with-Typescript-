...
const SubmitButton = ({ formId }) => {
    ...
    return (react.createElement("div", { className: "form-submit-button flex border-t border-divider mt-4 pt-4 justify-between" },
        react.createElement(common_Button, { title: "SIGN IN", onAction: () => {
    ...
    return (react.createElement("div", { className: "admin-login-form" },
        ...
        react.createElement(Form, { action: authUrl, method: "POST", id: "adminLoginForm", onSuccess: onSuccess, submitBtn: false },
            react.createElement(common_Area, { id: "adminLoginForm", coreComponents: [
                    {
                        component: {
                            default: (react.createElement(EmailField, { prefixIcon: react.createElement(EnvelopeIcon/* default */.A, { className: "h-5 w-5" }), label: "Email", name: "email", placeholder: "Email", required: true, validation: {
                    ...
                    {
                        component: {
                            default: (react.createElement(PasswordField, { prefixIcon: react.createElement(LockClosedIcon/* default */.A, { className: "h-5 w-5" }), label: "Password", name: "password", placeholder: "Password", required: true, validation: {
...
common_Area.defaultProps.components = {
  content: {
    eb2917acb08a16903234ab37bd635e163: {
      id: 'eb2917acb08a16903234ab37bd635e163',
      sortOrder: 10,
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(45083)))
