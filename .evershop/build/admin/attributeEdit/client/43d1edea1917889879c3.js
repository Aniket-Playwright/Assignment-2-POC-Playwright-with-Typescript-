...
function AttributeEditForm({ action, gridUrl }) {
    return (react.createElement(Form, { action: action, method: "PATCH", id: "attributeEditForm", submitBtn: false },
        ...
        react.createElement(FormButtons, { formId: "attributeEditForm", cancelUrl: gridUrl })));
}
...
function General({ attribute }) {
    return (react.createElement(Card, { title: "Setting", subdued: true },
        react.createElement(Card.Session, null,
            react.createElement(RadioGroupField, { name: "is_required", label: "Is Required?", options: [
                    { value: 0, label: 'No' },
                    { value: 1, label: 'Yes' }
                ], required: true, validation: {
                    required: 'This field is required'
                }, defaultValue: (attribute === null || attribute === void 0 ? void 0 : attribute.isRequired) === 0 ? 0 : 1 })),
        react.createElement(Card.Session, null,
            react.createElement(RadioGroupField, { name: "is_filterable", label: "Is Filterable?", options: [
                    { value: 0, label: 'No' },
                    { value: 1, label: 'Yes' }
                ], required: true, validation: {
                    required: 'This field is required'
                }, defaultValue: (attribute === null || attribute === void 0 ? void 0 : attribute.isFilterable) === 1 ? 1 : 0 })),
        react.createElement(Card.Session, null,
            react.createElement(RadioGroupField, { name: "display_on_frontend", label: "Display on Frontend?", options: [
                    { value: 0, label: 'No' },
                    { value: 1, label: 'Yes' }
                ], required: true, validation: {
                    required: 'This field is required'
                }, defaultValue: (attribute === null || attribute === void 0 ? void 0 : attribute.displayOnFrontend) === 1 ? 1 : 0 })),
        react.createElement(Card.Session, null,
            react.createElement(NumberField, { name: "sort_order", label: "Sort Order", placeholder: "Sort order", required: true, validation: {
                    required: 'Sort order is required',
                    min: {
                        value: 0,
                        message: 'Sort order must be a positive number'
                    }
                }, defaultValue: attribute === null || attribute === void 0 ? void 0 : attribute.sortOrder }))));
}
...
const Groups = ({ groups, createGroupApi }) => {
    ...
    return (react.createElement("div", null,
        ...
        react.createElement("div", { className: "grid gap-5 grid-cols-2" },
            react.createElement("div", null,
                react.createElement(index_esm/* Controller */.xI, { name: "groups", control: control, defaultValue: groups.map((group) => group.value), render: ({ field }) => (react.createElement(react_select_esm/* default */.Ay, { ...field, options: data.attributeGroups.items, hideSelectedOptions: true, isMulti: true, onChange: (selectedOptions) => {
...
common_Area.defaultProps.components = {
  ...
  content: {
    e234fc3c59ecae7b5f98f8061058f3180: {
      id: 'e234fc3c59ecae7b5f98f8061058f3180',
      sortOrder: 10,
      component: { default: AttributeEditForm }
    },
    e9c00d17445d2cc1ea96dcb9f7257759c: {
      id: 'e9c00d17445d2cc1ea96dcb9f7257759c',
      sortOrder: 5,
      component: { default: AttributeEditPageHeading }
    }
  },
  rightSide: {
    e38e75c537e5d2d3fe875c0a724743f91: {
      id: 'e38e75c537e5d2d3fe875c0a724743f91',
      sortOrder: 10,
      component: { default: General }
    }
  },
  leftSide: {
    ebf9234f6ef8408d8d6e965020b819a90: {
      id: 'ebf9234f6ef8408d8d6e965020b819a90',
      sortOrder: 10,
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(82565)))
