...
function CollectionNewForm({ action, gridUrl }) {
    return (react.createElement(Form, { id: "collectionNewForm", action: action, submitBtn: false, method: "POST", onSuccess: (response) => {
            react_toastify_esm/* toast */.oR.success('Collection created successfully!');
            setTimeout(() => {
        ...
        react.createElement("div", { className: "w-2/3", style: { margin: '0 auto' } },
            ...
            react.createElement(FormButtons, { formId: "collectionNewForm", cancelUrl: gridUrl }))));
}
...
common_Area.defaultProps.components = {
  ...
  content: {
    ...
    ede97dd3a1fd85cd0c8600313b25ff942: {
      id: 'ede97dd3a1fd85cd0c8600313b25ff942',
      sortOrder: 10,
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(62988)))
