...
;// ./node_modules/@evershop/evershop/dist/modules/tax/pages/admin/taxSetting/components/RateForm.js
        ...
        react.createElement(Form, { id: "taxRateForm", method: rate ? 'PATCH' : 'POST', action: saveRateApi, submitBtn: false, onSuccess: async (response) => {
            ...
            react.createElement(Card.Session, null,
                react.createElement("div", { className: "flex justify-end gap-2" },
                    react.createElement(common_Button, { title: "Cancel", variant: "secondary", onAction: closeModal }),
...
;// ./node_modules/@evershop/evershop/dist/modules/tax/pages/admin/taxSetting/components/Rate.js
...
function Rate({ rate, getTaxClasses }) {
    ...
    return (react.createElement(react.Fragment, null,
        react.createElement(react.Fragment, null,
            react.createElement("td", { className: "border-none py-2" }, rate.name),
            react.createElement("td", { className: "border-none py-2" },
                rate.rate,
                "%"),
            react.createElement("td", { className: "border-none py-2" }, rate.isCompound ? 'Yes' : 'No'),
            react.createElement("td", { className: "border-none py-2" }, rate.priority),
            react.createElement("td", { className: "border-none py-2" },
        ...
        react.createElement(Modal, { title: "Edit tax rate", onClose: modal.close, isOpen: modal.isOpen },
            react.createElement(RateForm, { saveRateApi: rate.updateApi, closeModal: () => modal.close(), getTaxClasses: getTaxClasses, rate: rate }))));
}

//# sourceMappingURL=Rate.js.map
;// ./node_modules/@evershop/evershop/dist/modules/tax/pages/admin/taxSetting/components/Rates.js





function Rates({ getTaxClasses, rates, addRateApi }) {
    const modal = useModal();
    return (react.createElement("div", { className: "my-5" },
        react.createElement("table", { className: "border-collapse divide-y" },
            ...
            react.createElement("tbody", null, rates.map((rate) => (react.createElement("tr", { key: rate.uuid, className: "border-divider py-5" },
        ...
        react.createElement(Modal, { title: "Add a tax rate", onClose: modal.close, isOpen: modal.isOpen },
            react.createElement(RateForm, { saveRateApi: addRateApi, closeModal: () => modal.close(), getTaxClasses: getTaxClasses }))));
}
//# sourceMappingURL=Rates.js.map
;// ./node_modules/@evershop/evershop/dist/modules/tax/pages/admin/taxSetting/components/TaxClass.js
...
;// ./node_modules/@evershop/evershop/dist/modules/tax/pages/admin/taxSetting/components/TaxClasses.js


function TaxClasses({ getTaxClasses, classes }) {
    return (react.createElement(react.Fragment, null, classes.map((taxClass) => (react.createElement(TaxClass, { key: taxClass.uuid, taxClass: taxClass, getTaxClasses: getTaxClasses })))));
}
//# sourceMappingURL=TaxClasses.js.map
;// ./node_modules/@evershop/evershop/dist/modules/tax/pages/admin/taxSetting/components/TaxClassForm.js
    ...
    return (react.createElement(Card, { title: "Create a tax class" },
        react.createElement(Form, { id: "createTaxClass", method: "POST", action: saveTaxClassApi, submitBtn: false, onSuccess: async () => {
            ...
            react.createElement(Card.Session, { title: "Tax class name" },
                react.createElement(InputField, { name: "name", type: "text", label: "Tax class name", defaultValue: "", placeholder: "Enter tax class name", required: true, validation: { required: 'Tax class name is required' } })),
            react.createElement(Card.Session, null,
                react.createElement("div", { className: "flex justify-end gap-2" },
                    react.createElement(common_Button, { title: "Cancel", variant: "secondary", onAction: closeModal }),
                    react.createElement(common_Button, { title: "Save", variant: "primary", onAction: () => {
...
;// ./node_modules/@evershop/evershop/dist/modules/tax/pages/admin/taxSetting/TaxSetting.js
...
`;
function TaxSetting({ createTaxClassApi, saveSettingApi, setting }) {
    const modal = useModal();
    const [countriesQueryData] = (0,urql_es/* useQuery */.IT)({
        query: CountriesQuery
    });
    const [taxClassesQueryData, reexecuteQuery] = (0,urql_es/* useQuery */.IT)({
    ...
    return (react.createElement("div", { className: "main-content-inner" },
        react.createElement("div", { className: "grid grid-cols-6 gap-x-5 grid-flow-row " },
            react.createElement("div", { className: "col-span-2" },
                react.createElement(SettingMenu, null)),
            react.createElement("div", { className: "col-span-4 grid grid-cols-1 gap-5" },
                react.createElement(Card, null,
                    ...
                    react.createElement(Card.Session, { title: "Basic configuration" },
                        react.createElement(Form, { id: "taxBasicConfig", method: "POST", action: saveSettingApi, successMessage: "Tax setting has been saved successfully!" },
                            react.createElement("div", { className: "grid grid-cols-2 gap-5" },
                                react.createElement("div", null,
                                    react.createElement(SelectField, { name: "defaultShippingTaxClassId", label: "Shipping tax class", defaultValue: setting.defaultShippingTaxClassId || '', placeholder: "None", options: [
                                            {
                                                value: -1,
                                ...
                                react.createElement("div", null,
                                    react.createElement(SelectField, { name: "baseCalculationAddress", label: "Base calculation address", defaultValue: setting.baseCalculationAddress || '', options: [
                                            {
                ...
                react.createElement(Card, { title: "Tax classes" },
                    react.createElement(TaxClasses, { classes: taxClassesQueryData.data.taxClasses.items, getTaxClasses: reexecuteQuery }),
                    react.createElement(Card.Session, null,
                        react.createElement("div", null,
                            react.createElement(common_Button, { title: "Create new tax class", variant: "primary", onAction: () => modal.open() })))))),
        react.createElement(Modal, { title: 'Create a tax class', onClose: modal.close, isOpen: modal.isOpen },
            react.createElement(TaxClassForm, { saveTaxClassApi: createTaxClassApi, closeModal: () => modal.close(), getTaxClasses: reexecuteQuery }))));
}
const TaxSetting_layout = {
    areaId: 'content',
    sortOrder: 10
};
const TaxSetting_query = (/* unused pure expression or super */ null && (`
  query Query {
...
;// ./.evershop/build/admin/taxSetting/client/entry.js
...
common_Area.defaultProps.components = {
  ...
  content: {
    ef9e022229a117d2fb9b2accd22a7be01: {
      id: 'ef9e022229a117d2fb9b2accd22a7be01',
      sortOrder: 10,
      component: { default: TaxSetting }
    }
  },
  '*': {
    collection_products: {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(64609)))
