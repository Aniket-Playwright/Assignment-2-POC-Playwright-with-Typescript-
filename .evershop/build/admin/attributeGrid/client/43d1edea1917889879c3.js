...
;// ./node_modules/@evershop/evershop/dist/modules/catalog/pages/admin/attributeGrid/rows/AttributeName.js

function AttributeNameRow({ url, name }) {
    return (react.createElement("td", null,
        react.createElement("div", null,
            react.createElement("a", { className: "hover:underline font-semibold", href: url }, name))));
}
//# sourceMappingURL=AttributeName.js.map
;// ./node_modules/@evershop/evershop/dist/modules/catalog/pages/admin/attributeGrid/rows/GroupRow.js
...
;// ./node_modules/@evershop/evershop/dist/modules/catalog/pages/admin/attributeGrid/Grid.js
    ...
    const deleteAttributes = async () => {
        ...
        try {
            const promises = attributes
                ...
                .map((attribute) => axios/* default */.A.delete(attribute.deleteApi, {
                validateStatus: () => true
            }));
...
function AttributeGrid({ attributes: { items: attributes, total, currentFilters = [] } }) {
    var _a;
    ...
    return (react.createElement(Card, null,
        react.createElement(Card.Session, { title: react.createElement(Form, { submitBtn: false, id: "attributeGridFilter" },
                react.createElement(InputField, { name: "name", placeholder: "Search", defaultValue: (_a = currentFilters.find((f) => f.key === 'name')) === null || _a === void 0 ? void 0 : _a.value, onKeyPress: (e) => {
                        var _a;
        ...
        react.createElement("table", { className: "listing sticky" },
            react.createElement("thead", null,
                react.createElement("tr", null,
                    ...
                    react.createElement(common_Area, { className: "", id: "attributeGridHeader", noOuter: true, coreComponents: [
                            {
                                component: {
            ...
            react.createElement("tbody", null,
                ...
                attributes.map((a) => (react.createElement("tr", { key: a.attributeId },
                    react.createElement("td", null,
                        react.createElement("div", { className: "form-field mb-0" },
                            react.createElement("input", { type: "checkbox", checked: selectedRows.includes(a.uuid), onChange: (e) => {
                                    if (e.target.checked) {
                    ...
                    react.createElement(common_Area, { className: "", id: "attributeGridRow", row: a, noOuter: true, coreComponents: [
                            {
                                component: {
                            ...
                            {
                                component: {
                                    default: ({ areaProps }) => react.createElement("td", null, a.type)
                                },
                                sortOrder: 20
                            },
                            {
                                component: {
                                    default: () => react.createElement("td", null, a.isRequired ? 'Yes' : 'No')
                                },
                                sortOrder: 25
                            },
                            {
                                component: {
                                    default: () => react.createElement("td", null, a.isFilterable ? 'Yes' : 'No')
                                },
                                sortOrder: 30
                            }
                        ] })))))),
...
AttributeGrid.propTypes = {
    attributes: prop_types_default().shape({
        items: prop_types_default().arrayOf(prop_types_default().shape({
            uuid: (prop_types_default()).string.isRequired,
            attributeId: (prop_types_default()).string.isRequired,
            attributeName: (prop_types_default()).string.isRequired,
            attributeCode: (prop_types_default()).string.isRequired,
            type: (prop_types_default()).string.isRequired,
            isRequired: (prop_types_default()).number.isRequired,
            isFilterable: (prop_types_default()).number.isRequired,
...
;// ./node_modules/@evershop/evershop/dist/modules/catalog/pages/admin/attributeGrid/NewAttributeButton.js



function NewAttributeButton({ newAttributeUrl }) {
    return react.createElement(common_Button, { url: newAttributeUrl, title: "New Attribute" });
}
NewAttributeButton.propTypes = {
    newAttributeUrl: (prop_types_default()).string.isRequired
};
const NewAttributeButton_layout = {
    areaId: 'pageHeadingRight',
    sortOrder: 10
};
const NewAttributeButton_query = (/* unused pure expression or super */ null && (`
  query Query {
...
;// ./node_modules/@evershop/evershop/dist/modules/catalog/pages/admin/attributeGrid/PageHeading.js


function AttributGridPageHeading() {
    return react.createElement(PageHeading, { heading: "Attributes" });
}
...
;// ./.evershop/build/admin/attributeGrid/client/entry.js
...
common_Area.defaultProps.components = {
  ...
  content: {
    e6e6684d5fdb6bc5dc1755212fe4d4b07: {
      id: 'e6e6684d5fdb6bc5dc1755212fe4d4b07',
      sortOrder: 20,
      component: { default: AttributeGrid }
    },
    e896c77f751ef7a0a88c54f051f0422f9: {
      id: 'e896c77f751ef7a0a88c54f051f0422f9',
      sortOrder: 10,
      component: { default: AttributGridPageHeading }
    }
  },
  pageHeadingRight: {
    e8bc7efac958cbfe5caf36f3fde148621: {
      id: 'e8bc7efac958cbfe5caf36f3fde148621',
      sortOrder: 10,
      component: { default: NewAttributeButton }
    }
  },
  settingPageMenu: {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [7755], () => (__webpack_require__(57515)))
