...
function Name() {
    return (react.createElement("h1", { className: "page-name text-center mt-6 mb-4" }, _('404 Page Not Found')));
}
function Content({ continueShoppingUrl }) {
    return (react.createElement("div", { className: "page-content" },
        ...
        react.createElement("div", { className: "mt-5 text-center" },
            react.createElement(common_Button, { title: _('Continue shopping'), url: continueShoppingUrl, outline: true }))));
}
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [4286], () => (__webpack_require__(12069)))
