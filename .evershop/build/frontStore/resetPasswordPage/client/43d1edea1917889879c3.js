...
;// ./node_modules/@evershop/evershop/dist/components/frontStore/customer/ResetPasswordForm.js
...
const ResetPasswordForm = ({ title, subtitle, action, className, onSuccess }) => {
    ...
    return (react.createElement("div", { className: "flex justify-center items-center" },
        react.createElement("div", { className: `reset__password__form ${className}` },
            react.createElement("div", { className: "reset__password__form__inner" },
                title && (react.createElement("h1", { className: "reset__password__form__title text-2xl text-center mb-6" }, title)),
                subtitle && (react.createElement("p", { className: "reset__password__form__subtitle text-center mb-6" }, subtitle)),
                error && react.createElement("div", { className: "text-critical mb-2" }, error),
                react.createElement(Form, { id: "resetPasswordForm", form: form, action: action, method: "POST", onSuccess: (response) => {
                        if (!response.error) {
                            onSuccess();
                        }
                        else {
                    ...
                    react.createElement(EmailField, { prefixIcon: react.createElement(EnvelopeIcon/* default */.A, { className: "h-5 w-5" }), name: "email", label: _('Email'), placeholder: _('Email'), required: true, validation: {
                            required: _('Email is required')
                        } }),
                    react.createElement("div", { className: "reset__password__form__submit__button flex border-t border-divider mt-2 pt-2" },
                        react.createElement(common_Button, { title: _('Reset Password'), type: "submit", onAction: () => {
                                document.getElementById('resetPasswordForm').dispatchEvent(new Event('submit', { cancelable: true, bubbles: true }));
                            }, isLoading: loading })))))));
};
//# sourceMappingURL=ResetPasswordForm.js.map
;// ./node_modules/@evershop/evershop/dist/modules/customer/pages/frontStore/resetPasswordPage/ResetPasswordPage.js



function Success() {
    return (react.createElement("div", { className: "flex justify-center items-center h-full" },
        react.createElement("div", { className: "reset__password__success flex justify-center items-center pt-10 md:pt-36" },
            react.createElement("div", { className: "reset__password__success__inner max-w-md px-4" },
...
function ResetPasswordPage({ action }) {
    const [success, setSuccess] = react.useState(false);
    return success ? (react.createElement(Success, null)) : (react.createElement(ResetPasswordForm, { title: _('Reset Your Password'), subtitle: _('Please enter your email to receive a reset link'), className: "w-[30rem] max-w-max md:max-w-[80%] bg-white rounded-3xl p-6 shadow-lg border border-divider", action: action, onSuccess: () => {
            setSuccess(true);
        } }));
}
const ResetPasswordPage_layout = {
    areaId: 'content',
    sortOrder: 10
};
const ResetPasswordPage_query = (/* unused pure expression or super */ null && (`
  query Query {
...
common_Area.defaultProps.components = {
  ...
  content: {
    ...
    ed848b7efc9f7130a6c1f9465f5bf87c6: {
      id: 'ed848b7efc9f7130a6c1f9465f5bf87c6',
      sortOrder: 10,
      component: { default: ResetPasswordPage }
    }
  },
  head: {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [4286], () => (__webpack_require__(57179)))
