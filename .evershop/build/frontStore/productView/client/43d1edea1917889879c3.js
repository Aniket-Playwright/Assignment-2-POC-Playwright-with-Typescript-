...
;// ./node_modules/@evershop/evershop/dist/components/frontStore/catalog/ProductContext.js

const ProductContext = (0,react.createContext)(undefined);
const ProductProvider = ({ children, product }) => {
    return (react.createElement(ProductContext.Provider, { value: product }, children));
};
const useProduct = () => {
    const context = (0,react.useContext)(ProductContext);
    if (context === undefined) {
...
;// ./node_modules/@evershop/evershop/dist/components/frontStore/catalog/Media.js
...
const SliderComponent = lib;
const PrevArrow = (props) => {
    const { className, onClick } = props;
    return (react.createElement("button", { className: `${className} custom-arrow prev-arrow`, onClick: onClick, "aria-label": "Previous slide" },
...
const NextArrow = (props) => {
    const { className, onClick } = props;
    return (react.createElement("button", { className: `${className} custom-arrow next-arrow`, onClick: onClick, "aria-label": "Next slide" },
        react.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" },
            react.createElement("path", { d: "M9 18l6-6-6-6" }))));
};
const Media = ({ imageSize = { width: 600, height: 600 }, thumbnailSize = { width: 100, height: 100 }, modalSize = { width: 1200, height: 1200 } }) => {
    const product = useProduct();
    const [isModalOpen, setIsModalOpen] = (0,react.useState)(false);
    const [activeSlide, setActiveSlide] = (0,react.useState)(0);
    const [isImageLoading, setIsImageLoading] = (0,react.useState)(false);
    const mainSliderRef = (0,react.useRef)(null);
    const modalSliderRef = (0,react.useRef)(null);
    const allImages = [];
    ...
    const mainSliderSettings = {
        ...
        customPaging: function (i) {
            var _a;
            return (react.createElement("div", { className: "thumbnail-wrapper" },
                react.createElement(Image, { src: (_a = allImages[i]) === null || _a === void 0 ? void 0 : _a.url, alt: `Thumbnail ${i + 1}`, width: thumbnailSize.width, height: thumbnailSize.height, objectFit: "contain" })));
        }
    };
    ...
    return (react.createElement("div", { className: "product-media-container" },
        react.createElement("div", { className: "main-image-container" },
            allImages.length > 0 && (react.createElement(SliderComponent.default, { ref: mainSliderRef, ...mainSliderSettings, className: "product-slider" }, allImages.map((image, index) => (react.createElement("div", { key: index, className: "product-image", onClick: () => openModal(index), style: { width: imageSize.width, height: imageSize.height } },
                react.createElement(Image, { src: image.url, alt: image.alt || 'Product image', width: imageSize.width, height: imageSize.height, objectFit: "scale-down" })))))),
            allImages.length === 0 && (react.createElement("div", { className: "w-full h-full flex items-center justify-center py-24 bg-gray-100" },
                react.createElement(ProductNoThumbnail, { className: "w-48 h-48" })))),
        isModalOpen && (react.createElement("div", { className: "product-image-modal" },
            react.createElement("div", { className: "modal-overlay", onClick: closeModal }),
            react.createElement("div", { className: "modal-content" },
                react.createElement("button", { className: "modal-close", onClick: closeModal, "aria-label": "Close fullscreen view" },
                ...
                react.createElement("div", { className: "modal-slider-container" },
                    isImageLoading && (react.createElement("div", { className: "loading-indicator" },
                        react.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: "40", height: "40", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className: "spinner" },
                            react.createElement("circle", { cx: "12", cy: "12", r: "10" }),
                            react.createElement("path", { d: "M12 2a10 10 0 1 0 10 10" })))),
                    react.createElement(SliderComponent.default, { ref: modalSliderRef, ...modalSliderSettings }, allImages.map((image, index) => (react.createElement("div", { key: index, className: "modal-image" },
                        react.createElement(Image, { src: image.url, alt: image.alt || 'Product image', width: fullscreenWidth, height: fullscreenHeight, objectFit: "contain" })))))))))));
};
//# sourceMappingURL=Media.js.map
;// ./node_modules/@evershop/evershop/dist/components/frontStore/catalog/ProductSingleAttributes.js



const ProductSingleAttributes = () => {
    ...
    return (react.createElement(react.Fragment, null,
        react.createElement(common_Area, { id: "productAttributesBefore", noOuter: true }),
        react.createElement("div", { className: "product__single__attributes py-3" },
            react.createElement("ul", { className: "list-none" }, list.map((attribute) => (react.createElement("li", { key: attribute.attributeCode, className: "py-1" },
                react.createElement("strong", null,
                    attribute.attributeName,
                    ": "),
                ' ',
                react.createElement("span", null, attribute.optionText)))))),
        react.createElement(common_Area, { id: "productAttributesAfter", noOuter: true })));
};
//# sourceMappingURL=ProductSingleAttributes.js.map
...
;// ./node_modules/@evershop/evershop/dist/components/frontStore/catalog/ProductSingleDescription.js
...
const ProductSingleDescription = () => {
    ...
    return (react.createElement(react.Fragment, null,
        react.createElement(common_Area, { id: "productDescriptionBefore", noOuter: true }),
        react.createElement("div", { className: "product__single__description mt-8" },
            react.createElement("h3", null, _('Product Description')),
            react.createElement(Editor, { rows: description })),
        react.createElement(common_Area, { id: "productDescriptionAfter", noOuter: true })));
};
//# sourceMappingURL=ProductSingleDescription.js.map
...
;// ./node_modules/@evershop/evershop/dist/components/frontStore/catalog/DefaultVariantSelectorRender.js
...
const DefaultVariantOptionItem = ({ option, attribute, isSelected, onSelect }) => {
    ...
    return (react.createElement("li", { key: option.optionId, className: className },
...
const DefaultVariantAttribute = ({ attribute, options, onSelect, OptionItem = DefaultVariantOptionItem }) => {
    return (react.createElement("div", { key: attribute.attributeCode },
        react.createElement("div", { className: "mb-2 text-textSubdued uppercase" },
            react.createElement("span", null, attribute.attributeName)),
        react.createElement("ul", { className: "variant-option-list flex justify-start gap-2 flex-wrap" }, options.map((option) => (react.createElement(OptionItem, { key: option.optionId, option: option, attribute: attribute, isSelected: attribute.selected && attribute.selectedOption === option.optionId, onSelect: onSelect }))))));
};

//# sourceMappingURL=DefaultVariantSelectorRender.js.map
;// ./node_modules/@evershop/evershop/dist/components/frontStore/catalog/VariantSelector.js
...
const processAttributes = (vs, attributes, currentUrl) => {
    ...
    newAttributes = attributes.map((attribute) => {
        ...
        const check = Array.from(params).find(([key, value]) => key === attribute.attributeCode &&
            attribute.options.find((option) => option.optionId === parseInt(value, 10)));
        if (check) {
            const terms = [
                ...selectedOptions,
...
function VariantSelector({ AttributeRenderer = DefaultVariantAttribute, OptionRenderer = DefaultVariantOptionItem }) {
    ...
    const initialAttributes = (0,react.useMemo)(() => processAttributes(vs, (vs === null || vs === void 0 ? void 0 : vs.variantAttributes) || [], currentProductUrl), [vs, currentProductUrl]);
    ...
    (0,react.useEffect)(() => {
        const handleProductChange = () => {
            const newAttributes = processAttributes(vs, (vs === null || vs === void 0 ? void 0 : vs.variantAttributes) || [], currentProductUrl);
    ...
    return (react.createElement("div", { className: "variant variant__container grid grid-cols-1 gap-2 mt-5" },
        attributes.map((attribute) => {
            const options = attribute.options.filter((v, j, s) => s.findIndex((o) => o.optionId === v.optionId) === j && v.productId);
            return (react.createElement(AttributeRenderer, { key: attribute.attributeCode, attribute: attribute, options: options, onSelect: handleOptionClick, OptionItem: OptionRenderer }));
        }),
        react.createElement("input", { type: "hidden", ...register('variant_selected', {
                validate: validate
            }) }),
        errors.variant_selected && (react.createElement("div", { className: "text-critical" }, _('Please select variant options')))));
}
//# sourceMappingURL=VariantSelector.js.map
;// ./node_modules/@evershop/evershop/dist/components/frontStore/catalog/ProductSingleForm.js
                ...
                },
                {
                    component: {
                        default: (react.createElement(AddToCart, { product: {
                                ...
                                react_toastify_esm/* toast */.oR.error(errorMessage || _('Failed to add product to cart'));
                            } }, (state, actions) => (react.createElement(react.Fragment, null,
                            state.isInStock === true && (react.createElement(common_Button, { title: _('ADD TO CART'), outline: true, isLoading: state.isLoading, onAction: () => {
                            ...
                            state.isInStock === false && (react.createElement(common_Button, { title: _('SOLD OUT'), onAction: () => { }, className: "w-full py-3 text-lg font-base !rounded-full" }))))))
                    },
                    sortOrder: 30,
                    id: 'addToCartButton'
                }
...
;// ./node_modules/@evershop/evershop/dist/components/frontStore/catalog/ProductSingleName.js



const ProductSingleName = () => {
    const { name } = useProduct();
    return (react.createElement(react.Fragment, null,
        react.createElement(common_Area, { id: "productNameBefore", noOuter: true }),
        react.createElement("h1", { className: "product__single__name capitalize" }, name),
        react.createElement(common_Area, { id: "productNameAfter", noOuter: true })));
};
//# sourceMappingURL=ProductSingleName.js.map
;// ./node_modules/@evershop/evershop/dist/modules/catalog/pages/frontStore/productView/ProductView.js
...
function ProductView({ product }) {
    return (react.createElement(ProductProvider, { product: product },
        react.createElement("div", { className: "product__detail" },
            react.createElement(common_Area, { id: "productPageTop", className: "product__page__top" }),
            react.createElement("div", { className: "product__page__middle page-width" },
                react.createElement("div", { className: "grid grid-cols-1 gap-7 md:grid-cols-2" },
                    react.createElement(common_Area, { id: "productPageMiddleLeft", className: "product__detail__left", coreComponents: [
                            {
                    ...
                    react.createElement(common_Area, { id: "productPageMiddleRight", className: "product__detail__right", coreComponents: [
                            {
                ...
                react.createElement(ProductSingleDescription, null)),
            react.createElement(common_Area, { id: "productPageBottom", className: "product__page__bottom" }))));
}
...
function Slideshow_PrevArrow(props) {
    const { onClick } = props;
...
function Slideshow_NextArrow(props) {
    const { onClick } = props;
...
const Slideshow_SliderComponent = lib["default"];
function Slideshow({ slideshowWidget: { slides = [], autoplay = true, autoplaySpeed = 3000, arrows = true, dots = true } }) {
    const settings = {
        ...
        pauseOnHover: true,
        adaptiveHeight: true,
        nextArrow: arrows ? react.createElement(Slideshow_NextArrow, null) : undefined,
        prevArrow: arrows ? react.createElement(Slideshow_PrevArrow, null) : undefined,
        customPaging: function (i) {
    ...
    return (react.createElement("div", { className: containerClasses, style: containerStyle },
        react.createElement(Slideshow_SliderComponent, { ...settings, style: sliderStyle }, slides.map((slide) => (react.createElement("div", { key: slide.id, className: "relative lg:h-auto slide__wrapper !block", style: { display: 'block' } },
...
common_Area.defaultProps.components = {
  ...
  content: {
    ...
    ee438a163b28b3c3fb9895e749bd5dd0a: {
      id: 'ee438a163b28b3c3fb9895e749bd5dd0a',
      sortOrder: 10,
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [4286], () => (__webpack_require__(94603)))
