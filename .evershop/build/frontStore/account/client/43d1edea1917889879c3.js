...
// EXTERNAL MODULE: ./node_modules/@heroicons/react/24/outline/esm/AtSymbolIcon.js
var AtSymbolIcon = __webpack_require__(2962);
...
;// ./node_modules/@evershop/evershop/dist/components/frontStore/customer/AccountInfo.js
...
function AccountInfo({ title, showLogout }) {
            ...
            react.createElement(common_Area, { id: "accountDetails", coreComponents: [
                    {
                        component: {
                            default: (react.createElement("div", { className: "account__details__name flex gap-2 py-2" },
                                react.createElement("div", null,
                                    react.createElement(UserCircleIcon/* default */.A, { width: 20, height: 20 })),
                    ...
                    },
                    {
                        component: {
                            default: () => (react.createElement("div", { className: "account__details__email flex gap-2 py-2" },
                                react.createElement("div", null,
                                    react.createElement(AtSymbolIcon/* default */.A, { width: 20, height: 20 })),
...
//# sourceMappingURL=Index.js.map
;// ./node_modules/@evershop/evershop/dist/components/frontStore/customer/MyAddresses.js
...
const Address = ({ address }) => {
    ...
    return (react.createElement("div", { className: `bg-white p-5 shadow rounded ${classes}` },
        ...
        react.createElement("div", { className: "flex justify-between items-center mt-2" },
            ...
            react.createElement("a", { href: "#", className: "text-critical hover:underline", onClick: async (e) => {
                    e.preventDefault();
                    try {
                        await deleteAddress(address.addressId);
                        react_toastify_esm/* toast */.oR.success(_('Address has been deleted successfully!'));
                    }
                    catch (error) {
                        react_toastify_esm/* toast */.oR.error(error.message);
                    }
                } }, _('Delete'))),
        react.createElement(Modal, { title: "Edit Address", onClose: modal.close, isOpen: modal.isOpen },
            react.createElement(Form, { id: "customerAddressForm", method: "PATCH", onSubmit: async (data) => {
                    await updateAddress(address.addressId, data);
                    modal.close();
                }, onSuccess: (response) => {
                    if (!response.error) {
                        modal.close();
                        react_toastify_esm/* toast */.oR.success(_('Address has been updated successfully!'));
                    }
                    else {
                        react_toastify_esm/* toast */.oR.error(response.error.message);
                    }
                } },
                react.createElement(Index, { address: address, fieldNamePrefix: "" }),
                react.createElement(CheckboxField, { label: _('Set as default'), defaultChecked: address.isDefault, name: "is_default" })))));
};
function MyAddresses({ title }) {
    ...
    return (react.createElement("div", null,
        title && (react.createElement("div", { className: "border-b mb-5 border-gray-200" },
            react.createElement("h2", null, _('Address Book')))),
        customer.addresses.length === 0 && (react.createElement("div", { className: "order-history-empty" }, _('You have no addresses saved'))),
        react.createElement("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-5" }, customer.addresses.map((address) => (react.createElement(Address, { key: address.uuid, address: address })))),
        react.createElement("br", null),
        react.createElement("a", { href: "#", className: "text-interactive underline", onClick: (e) => {
                e.preventDefault();
                modal.open();
            } }, _('Add new address')),
        react.createElement(Modal, { title: _('Add new address'), onClose: modal.close, isOpen: modal.isOpen },
            react.createElement(Form, { id: "customerAddressForm", method: 'POST', onSubmit: async (data) => {
                    try {
                        await addAddress(data);
                        react_toastify_esm/* toast */.oR.success(_('Address has been saved successfully!'));
                    }
                    catch (error) {
                        react_toastify_esm/* toast */.oR.error(error.message);
                    }
                ...
                react.createElement(Index, { address: undefined, fieldNamePrefix: "" }),
                react.createElement(CheckboxField, { label: _('Set as default'), defaultChecked: false, name: "is_default" })))));
}
//# sourceMappingURL=MyAddresses.js.map
;// ./node_modules/@evershop/evershop/dist/components/frontStore/customer/OrderHistory.js
...
const OrderDetail = ({ order }) => {
    return (react.createElement("div", { className: "order border-divider" },
        react.createElement("div", { className: "order-inner grid grid-cols-1 md:grid-cols-3 gap-5" },
            react.createElement("div", { className: "order-items col-span-2" }, order.items.map((item) => (react.createElement("div", { className: "order-item mb-2 flex gap-5 items-center", key: item.productSku },
                react.createElement("div", { className: "thumbnail border border-divider p-2 rounded" },
                    item.thumbnail && (react.createElement(Image, { width: 100, height: 100, style: { maxWidth: '6rem' }, src: item.thumbnail, alt: item.productName })),
                ...
                react.createElement("div", { className: "order-header" },
                    react.createElement("div", { className: "order-number" },
                        react.createElement("span", { className: "font-bold" },
                            ...
                            ": #",
                            order.orderNumber),
                        react.createElement("span", { className: "italic pl-2" }, order.createdAt.text))),
...
function OrderHistory({ title }) {
    ...
    return (react.createElement("div", { className: "order-history divide-y" },
        title && react.createElement("h2", { className: "order-history-title" }, title),
        orders.length === 0 && (react.createElement("div", { className: "order-history-empty" }, _('You have not placed any orders yet'))),
        orders.map((order) => (react.createElement("div", { className: "order-history-order border-divider py-5", key: order.orderId },
            react.createElement(OrderDetail, { order: order, key: order.orderId }))))));
}
//# sourceMappingURL=OrderHistory.js.map
;// ./node_modules/@evershop/evershop/dist/modules/customer/pages/frontStore/account/MyAccount.js
...
function MyAccount() {
    return (react.createElement("div", null,
        ...
        react.createElement("div", { className: "page-width mt-7 grid grid-cols-1 md:grid-cols-3 gap-7" },
            react.createElement("div", { className: "col-span-1 md:col-span-2" },
                react.createElement(OrderHistory, { title: _('Recent Orders') })),
            react.createElement("div", { className: "col-span-1" },
                react.createElement(AccountInfo, { title: _('Account Information'), showLogout: true }))),
        react.createElement("div", { className: "page-width mt-7" },
            react.createElement(MyAddresses, { title: _('Address Book') }),
            react.createElement(common_Area, { id: "accountPageAddressBook", noOuter: true }))));
}
const MyAccount_layout = {
    areaId: 'content',
    sortOrder: 10
};
...
common_Area.defaultProps.components = {
  ...
  content: {
    ...
    ea69c6405c42d79d17ef83c8db634a4e5: {
      id: 'ea69c6405c42d79d17ef83c8db634a4e5',
      sortOrder: 10,
      component: { default: MyAccount }
    }
  },
  head: {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [4286], () => (__webpack_require__(77091)))
