        ...
        react.createElement("div", { className: "register__form__inner w-full" },
            ...
            react.createElement(Form, { id: "registerForm", method: "POST", onSubmit: async (data) => {
                ...
                react.createElement(common_Area, { id: "customerRegisterForm", coreComponents: [
                        {
                            component: {
                                default: (react.createElement(InputField, { prefixIcon: react.createElement(UserCircleIcon/* default */.A, { className: "h-5 w-5" }), name: "full_name", label: _('Full Name'), placeholder: _('Full Name'), required: true, validation: { required: _('Full Name is required') } }))
                            },
                            sortOrder: 10
                        },
                        {
                            component: {
                                default: (react.createElement(EmailField, { prefixIcon: react.createElement(EnvelopeIcon/* default */.A, { className: "h-5 w-5" }), name: "email", label: _('Email'), placeholder: _('Email'), required: true, validation: { required: _('Email is required') } }))
                            },
                            sortOrder: 20
                        },
                        {
                            component: {
                                default: (react.createElement(PasswordField, { prefixIcon: react.createElement(LockClosedIcon/* default */.A, { className: "h-5 w-5" }), name: "password", label: _('Password'), placeholder: _('Password'), required: true, showToggle: true, validation: { required: _('Password is required') } }))
                            },
                            sortOrder: 30
                        }
                    ] })),
...
function RegisterPage({ homeUrl, loginUrl }) {
    return (react.createElement("div", { className: "flex justify-center items-center flex-col gap-3" },
        react.createElement(CustomerRegistrationForm, { title: _('Create an account'), subtitle: _('Join us for exclusive offers and order tracking'), redirectUrl: homeUrl, onError: (error) => {
                react_toastify_esm/* toast */.oR.error(error);
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [4286], () => (__webpack_require__(66420)))
