...
var EnvelopeIcon = __webpack_require__(5763);
// EXTERNAL MODULE: ./node_modules/@heroicons/react/24/outline/esm/LockClosedIcon.js
var LockClosedIcon = __webpack_require__(55028);
        ...
        react.createElement("div", { className: "login__form__inner w-full" },
            ...
            react.createElement(Form, { id: "loginForm", method: "POST", onSubmit: async (data) => {
                ...
                react.createElement(common_Area, { id: "customerLoginForm", coreComponents: [
                        {
                            component: {
                                default: (react.createElement(InputField, { prefixIcon: react.createElement(EnvelopeIcon/* default */.A, { className: "h-5 w-5" }), label: _('Email'), name: "email", placeholder: _('Email'), required: true, validation: {
                        ...
                        {
                            component: {
                                default: (react.createElement(PasswordField, { prefixIcon: react.createElement(LockClosedIcon/* default */.A, { className: "h-5 w-5" }), label: _('Password'), name: "password", placeholder: _('Password'), required: true, validation: {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [4286], () => (__webpack_require__(43237)))
