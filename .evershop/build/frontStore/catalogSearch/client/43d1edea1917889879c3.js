...
`));
//# sourceMappingURL=SearchBox.js.map
;// ./node_modules/@evershop/evershop/dist/components/frontStore/catalog/SearchContext.js

const SearchContext = (0,react.createContext)(undefined);
const SearchProvider = ({ children, searchData }) => {
    return (react.createElement(SearchContext.Provider, { value: searchData }, children));
};
const useSearch = () => {
...
;// ./node_modules/@evershop/evershop/dist/components/frontStore/catalog/SearchInfo.js
...
function SearchInfo() {
    ...
    return (react.createElement(react.Fragment, null,
        react.createElement(common_Area, { id: "searchInfoBefore", noOuter: true }),
        react.createElement("div", { className: "page-width" },
            react.createElement("div", { className: "mb-2 md:mb-5" },
                react.createElement("div", { className: "text-left " },
                    react.createElement("h1", { className: "search-name mt-6" }, _('Search results for "${keyword}"', { keyword }))))),
        react.createElement(common_Area, { id: "searchInfoAfter", noOuter: true })));
}
...
;// ./node_modules/@evershop/evershop/dist/components/frontStore/catalog/SearchProducts.js
...
function SearchProducts() {
    ...
    return (react.createElement(react.Fragment, null,
        react.createElement(common_Area, { id: "searchProductsBefore", noOuter: true }),
        react.createElement("div", null,
        ...
        react.createElement(common_Area, { id: "searchProductsAfter", noOuter: true })));
}
...
function SearchPage({ search }) {
    return (react.createElement(SearchProvider, { searchData: search },
        react.createElement(common_Area, { id: "searchPageTop", className: "search__page__top" }),
        ...
        react.createElement(common_Area, { id: "searchPageBottom", className: "search__page__bottom" })));
}
const SearchPage_layout = {
    areaId: 'content',
    sortOrder: 10
};
const SearchPage_query = (/* unused pure expression or super */ null && (`
  query Query {
...
const SearchPage_fragments = (/* unused pure expression or super */ null && (`
  fragment Product on Product {
    productId
    name
    sku
...
common_Area.defaultProps.components = {
  ...
  content: {
    ...
    ecdc4be9bc4676debce69f81c7db19fb1: {
      id: 'ecdc4be9bc4676debce69f81c7db19fb1',
      sortOrder: 10,
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [4286], () => (__webpack_require__(51784)))
